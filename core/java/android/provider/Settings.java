...
public final class Settings {
        ...
        /**
         * Activity Action: Show settings to allow configuration of location controller
         * extra package.
         * <p>
         * In some cases, a matching Activity may not exist, so ensure you
         * safeguard against this.
         ...
         * safeguard against this.
         * <p>
         * Input: {@link ConnectivityManager#EXTRA_TETHER_TYPE} should be included to
         * specify which type
         * of tethering should be checked.
         * {@link ConnectivityManager#EXTRA_PROVISION_CALLBACK} should
         * contain a {@link ResultReceiver} which will be called back with a tether
         * result code.
         * <p>
         ...
         * <p>
         * Input: {@link EXTRA_NETWORK_TEMPLATE} and {@link EXTRA_SUB_ID} should be
         * included to specify
         ...
         * @hide
         */
        @IntDef(prefix = "SET_ALL_RESULT_", value = { SET_ALL_RESULT_FAILURE, SET_ALL_RESULT_SUCCESS,
                        SET_ALL_RESULT_DISABLED })
        ...
        /**
         * A return value for {@link #KEY_CONFIG_SET_ALL_RETURN}, indicates a set all is
         * disabled.
         * 
         * @hide
         */
         ...
         * {@link android.app.Activity#isVoiceInteraction isVoiceInteraction} returns
         * true before
         * modifying the setting.
         * <p>
         * Input: To tell which state airplane mode should be set to, add the
         * {@link #EXTRA_AIRPLANE_MODE_ENABLED} extra to this Intent with the state
         * specified.
         ...
         * against this.
         * <p>
         * Input: {@link Intent#EXTRA_COMPONENT_NAME} must specify the accessibility
         * service component
         * name to be shown.
         * <p>
         * Output: Nothing.
        ...
        /**
         * Activity Action: Show settings to allow configuration of Reduce Bright
         * Colors.
         * <p>
         * In some cases, a matching Activity may not exist, so ensure you
         * safeguard against this.
         ...
         * preferences for its containing application. Optional but recommended for apps
         * that
         ...
         * sources
         *
         * Input: Optionally, the Intent's data URI can specify the application package
         * name to
         ...
         * set to
         * {@link android.app.Activity#RESULT_OK} if the permission was granted to the
         * app. Otherwise,
        ...
        /**
         * Activity Action: Show settings to allow configuration of cross-profile access
         * for apps
         *
         * Input: Optionally, the Intent's data URI can specify the application package
         * name to
        ...
        /**
         * Activity Action: Show the "Open by Default" page in a particular
         ...
         * <p>
         * In some cases, a matching Activity may not exist, so ensure you
         * safeguard against this. Add {@link #EXTRA_NUMBER_OF_CERTIFICATES} extra to
         * indicate the
        ...
        /**
         * Activity Action: Show setting page to process a Wi-Fi Easy Connect (aka DPP)
         * URI and start
         * configuration. This intent should be used when you want to use this device to
         * take on the
         * configurator role for an IoT/other device. When provided with a valid DPP URI
         * string, Settings will open a Wi-Fi selection screen for the user to indicate
         * which network
         ...
         * <p>
         * In some cases, a matching Activity may not exist, so ensure to safeguard
         * against this by
         * checking {@link WifiManager#isEasyConnectSupported()}.
         * <p>
         * Input: The Intent's data URI specifies bootstrapping information for
         * authenticating and
         * provisioning the peer, and uses a "DPP" scheme. The URI should be attached to
         * the intent
         * using {@link Intent#setData(Uri)}. The calling app can obtain a DPP URI in
         * any
         * way, e.g. by scanning a QR code or other out-of-band methods. The calling app
         * may also
         ...
         * <p>
         * Output: After calling {@link android.app.Activity#startActivityForResult},
         * the callback
         * {@code onActivityResult} will have resultCode
         * {@link android.app.Activity#RESULT_OK} if
         * the Wi-Fi Easy Connect configuration succeeded and the user tapped the 'Done'
         * button, or
         * {@link android.app.Activity#RESULT_CANCELED} if the operation failed and user
         * tapped the
         * 'Cancel' button. In case the operation has failed, a status code from
         * {@link android.net.wifi.EasyConnectStatusCallback}
         * {@code EASY_CONNECT_EVENT_FAILURE_*} will
         * be returned as an Extra {@link #EXTRA_EASY_CONNECT_ERROR_CODE}. Easy Connect
         * R2
         * Enrollees report additional details about the error they encountered, which
         * will be
         * provided in the {@link #EXTRA_EASY_CONNECT_ATTEMPTED_SSID},
         * {@link #EXTRA_EASY_CONNECT_CHANNEL_LIST}, and
         * {@link #EXTRA_EASY_CONNECT_BAND_LIST}.
         */
        @SdkConstant(SdkConstantType.ACTIVITY_INTENT_ACTION)
         ...
         * {@link #ACTION_PROCESS_WIFI_EASY_CONNECT_URI} intent to launch the Easy
         * Connect Operation.
         * This extra contains the integer error code of the operation - one of
         * {@link android.net.wifi.EasyConnectStatusCallback}
         * {@code EASY_CONNECT_EVENT_FAILURE_*}. If
         * there is no error, i.e. if the operation returns
         * {@link android.app.Activity#RESULT_OK},
         * then this extra is not attached to the result intent.
         * <p>
         * Use the {@link Intent#hasExtra(String)} to determine whether the extra is
         * attached and
         ...
         * #ACTION_PROCESS_WIFI_EASY_CONNECT_URI} intent to launch the Easy Connect
         * Operation. This
         * extra contains the SSID of the Access Point that the remote Enrollee tried to
         * connect to.
         * This value is populated only by remote R2 devices, and only for the following
         * error codes:
         ...
         * Therefore, always check if this extra is available using
         * {@link Intent#hasExtra(String)}. If
         * there is no error, i.e. if the operation returns
         * {@link android.app.Activity#RESULT_OK}, then
         ...
         * #ACTION_PROCESS_WIFI_EASY_CONNECT_URI} intent to launch the Easy Connect
         * Operation. This
         * extra contains the channel list that the Enrollee scanned for a network. This
         * value is
         * populated only by remote R2 devices, and only for the following error code:
         * {@link
         ...
         * there is no error, i.e. if the operation returns
         * {@link android.app.Activity#RESULT_OK}, then
         * this extra is not attached to the result intent. The list is JSON formatted,
         * as an array
         ...
         * <p>
         * This extra contains the bands the Enrollee supports, expressed as the Global
         * Operating
         * Class, see Table E-4 in IEEE Std 802.11-2016 Global operating classes. It is
         * used both as
         * input, to configure the Easy Connect operation and as output of the
         * operation.
         * <p>
         * As input: an optional extra to be attached to the
         * {@link #ACTION_PROCESS_WIFI_EASY_CONNECT_URI}. If attached, it indicates the
         * bands which
         * the remote device (enrollee, device-to-be-configured) supports. The Settings
         * operation
         * may take this into account when presenting the user with list of networks
         * configurations
         * to be used. The calling app may obtain this information in any out-of-band
         * method. The
         ...
         * {@link #ACTION_PROCESS_WIFI_EASY_CONNECT_URI} intent to launch the Easy
         * Connect Operation
         * . This value is populated only by remote R2 devices, and only for the
         * following error
         * codes:
         * {@link android.net.wifi.EasyConnectStatusCallback#EASY_CONNECT_EVENT_FAILURE_CANNOT_FIND_NETWORK},
         * {@link android.net.wifi.EasyConnectStatusCallback#EASY_CONNECT_EVENT_FAILURE_ENROLLEE_AUTHENTICATION},
         ...
         * Therefore, always check if this extra is available using
         * {@link Intent#hasExtra(String)}.
         * If there is no error, i.e. if the operation returns
         * {@link android.app.Activity#RESULT_OK}
         * , then this extra is not attached to the result intent.
         * <p>
        ...
        /**
         * Activity Action: Show settings to allow configuration of data and view data
         * usage.
         * <p>
         * In some cases, a matching Activity may not exist, so ensure you
         * safeguard against this.
        ...
        /**
         * Activity action: Show Settings app search UI when this action is available
         * for device.
         * <p>
         * Input: Nothing.
         * <p>
        ...
        /**
         * Activity Action: Show settings to enroll fingerprints, and setup
         * PIN/Pattern/Pass if
         * necessary.
         * 
        ...
        /**
         * Activity Action: Show settings to enroll biometrics, and setup
         * PIN/Pattern/Pass if
         * necessary. By default, this prompts the user to enroll biometrics with
         * strength
         * Weak or above, as defined by the CDD. Only biometrics that meet or exceed
         * Strong, as defined
         * in the CDD are allowed to participate in Keystore operations.
         * <p>
         * Input: extras {@link #EXTRA_BIOMETRIC_AUTHENTICATORS_ALLOWED} as an integer,
         * with
         ...
         * <p>
         * This can be passed as an extra field to the {@link #ACTION_BIOMETRIC_ENROLL}
         * intent to
         * indicate that only enrollment for sensors that meet these requirements should
         * be shown. The
         ...
         * If there is no extra in this Intent, subtypes from all installed input
         * methods
         ...
         * it is guaranteed there will always be an appropriate implementation for this
         * Intent action.
         * In prior releases of the platform this was optional, so ensure you safeguard
         * against it.
         * <p>
         * Input: Nothing.
         * <p>
        ...
        /**
         * Activity Action: Show screen for controlling which apps can draw on top of
         * other apps.
         * <p>
         * In some cases, a matching Activity may not exist, so ensure you safeguard
         * against this.
         * <p>
         * Input: Optionally, in versions of Android prior to
         * {@link android.os.Build.VERSION_CODES#R},
         * the Intent's data URI can specify the application package name to directly
         * invoke the
        ...
        /**
         * Activity Action: Show screen for controlling if the app specified in the data
         * URI of the
         * intent can draw on top of other apps.
         * <p>
         * Unlike {@link #ACTION_MANAGE_OVERLAY_PERMISSION}, which in Android {@link
         * android.os.Build.VERSION_CODES#R} can't be used to show a GUI for a specific
         * package,
         * permission {@code android.permission.INTERNAL_SYSTEM_WINDOW} is needed to
         * start an activity
         * with this intent.
         * <p>
         * In some cases, a matching Activity may not exist, so ensure you
         * safeguard against this.
         * <p>
         * Input: The Intent's data URI MUST specify the application package name whose
         * ability of
        ...
        /**
         * Activity Action: Show screen for controlling which apps are allowed to
         * write/modify
         * system settings.
         * <p>
         * In some cases, a matching Activity may not exist, so ensure you
         ...
         * Input: Intent's extra {@link android.content.Intent#EXTRA_PACKAGE_NAME} must
         * specify the
        ...
        /**
         * Activity Action: Show screen for controlling which apps can ignore battery
         * optimizations.
         * <p>
         * Input: Nothing.
         * <p>
         ...
         * PowerManager.isIgnoringBatteryOptimizations()} to determine if an application
         * is
         * already ignoring optimizations. You can use
         * {@link #ACTION_REQUEST_IGNORE_BATTERY_OPTIMIZATIONS} to ask the user to put
         * you
         * on this list.
         */
        @SdkConstant(SdkConstantType.ACTIVITY_INTENT_ACTION)
         ...
         * {@link #ACTION_IGNORE_BATTERY_OPTIMIZATION_SETTINGS}). For an app to use
         * this, it also
         * must hold the
         * {@link android.Manifest.permission#REQUEST_IGNORE_BATTERY_OPTIMIZATIONS}
         * permission.
         * <p>
         * <b>Note:</b> most applications should <em>not</em> use this; there are many
         * facilities
         * provided by the platform for applications to operate correctly in the various
         * power
         * saving modes. This is only for unusual applications that need to deeply
         * control their own
         * execution, at the potential expense of the user's battery life. Note that
         * these applications
         * greatly run the risk of showing to the user as high power consumers on their
         * device.
         * </p>
         * <p>
        ...
        /**
         * Activity Action: Open the advanced power usage details page of an associated
         * app.
         * <p>
         ...
         * {@link android.net.ConnectivityManager#getRestrictBackgroundStatus
         ...
         * restricted by adding an
         * {@link #EXTRA_AUTHORITIES} extra to this Intent with one or more syncable
         * content provider's
         * authorities. Only account types which can sync with that content provider
         * will be offered to
         * the user.
         * <p>
         * Input: Nothing.
         ...
         * extra to the Intent with one or more syncable content provider's authorities.
         * Only account
         * types which can sync with that content provider will be offered to the user.
         * <p>
         * Account types can also be filtered by adding an {@link #EXTRA_ACCOUNT_TYPES}
         * extra to the
         ...
         * safeguard against this.
         * <p>
         * The subscription ID of the subscription for which available network operators
         * should be
         ...
         * <p>
         * Users can grant and deny access to notifications for a {@link ComponentName}
         * from here.
         * See
         * {@link android.app.NotificationManager#isNotificationListenerAccessGranted(ComponentName)}
         * for more details.
         * <p>
         * Input: The extra {@link #EXTRA_NOTIFICATION_LISTENER_COMPONENT_NAME}
         * containing the name
        ...
        /**
         * Activity Extra: What component name to show the notification listener
         * permission
         * page for.
         * <p>
         * A string extra containing a {@link ComponentName}. This must be passed as an
         * extra field to
         ...
         * See
         * {@link android.app.NotificationManager#isNotificationPolicyAccessGranted()}
         * for more
         * details.
         * <p>
         * Input: Nothing.
         ...
         * <p>
         * Users can grant and deny access to Do Not Disturb configuration for an app
         * from here.
         * See
         * {@link android.app.NotificationManager#isNotificationPolicyAccessGranted()}
         * for more
         ...
         * <p>
         * Users can add, enable, disable, and remove automatic do not disturb rules
         * from this
         * screen. See {@link NotificationManager#addAutomaticZenRule(AutomaticZenRule)}
         * for more
         * details.
         * </p>
         * <p>
         ...
         * <p>
         * Input: The optional {@link #EXTRA_DO_NOT_DISTURB_MODE_MINUTES} extra can be
         * used to indicate
         * how long the user wishes to avoid interruptions for. The optional
         * {@link #EXTRA_DO_NOT_DISTURB_MODE_ENABLED} extra can be to indicate if the
         * user is
         * enabling or disabling do not disturb mode. If either extra is not included,
         * the
         ...
         * {@link #EXTRA_BATTERY_SAVER_MODE_ENABLED} extra to this Intent with the state
         * specified.
         * If the extra is not included, no changes will be made.
         * <p>
         * Output: Nothing.
        ...
        /**
         * Activity Action: Show Home selection settings. If there are multiple
         * activities
         * that can satisfy the {@link Intent#CATEGORY_HOME} intent, this screen allows
         * you
         ...
         * <p>
         * If a Settings activity handles this intent action, a "More defaults" entry
         * will be shown in
        ...
        /**
         * Activity Action: Show app listing settings, filtered by those that send
         * notifications.
         *
         * @hide
         */
         ...
         * <p>
         * Input: {@link #EXTRA_APP_PACKAGE}, the package containing the channel to
         * display.
        ...
        /**
         * Activity Extra: The package owner of the notification channel settings to
         * display.
         * <p>
         * This must be passed as an extra field to the
         * {@link #ACTION_CHANNEL_NOTIFICATION_SETTINGS}.
         */
        public static final String EXTRA_APP_PACKAGE = "android.provider.extra.APP_PACKAGE";

        /**
         * Activity Extra: The {@link NotificationChannel#getId()} of the notification
         * channel settings
         * to display.
         * <p>
         * This must be passed as an extra field to the
        ...
        /**
         * Activity Extra: The {@link NotificationChannel#getConversationId()} of the
         * notification
         * conversation settings to display.
         * <p>
         * This is an optional extra field to the
         * {@link #ACTION_CHANNEL_NOTIFICATION_SETTINGS}. If
         * included the system will first look up notification settings by channel and
         * conversation id,
         * and will fall back to channel id if a specialized channel for this
         * conversation doesn't
         * exist, similar to
         * {@link NotificationManager#getNotificationChannel(String, String)}.
         */
        public static final String EXTRA_CONVERSATION_ID = "android.provider.extra.CONVERSATION_ID";

        /**
         * Activity Extra: An {@code Arraylist<String>} of {@link NotificationChannel}
         * field names to
         ...
         * This is an optional extra field to the
         * {@link #ACTION_CHANNEL_NOTIFICATION_SETTINGS}. If
         * included the system will filter out any Settings that doesn't appear in this
         * list that
         ...
         * DPC apps can implement an activity that handles this intent in order to show
         * device policies
         ...
         *
         * <p>
         * Output: {@link android.app.Activity#RESULT_OK} if user selected an Autofill
         * Service belonging
         * to the caller package.
         *
         * <p>
         * <b>NOTE: </b> Applications should call
         * {@link android.view.autofill.AutofillManager#hasEnabledAutofillServices()}
         * and
         * {@link android.view.autofill.AutofillManager#isAutofillSupported()}, and only
         * use this action
         * to start an activity if they return {@code false} and {@code true}
         * respectively.
         */
        @SdkConstant(SdkConstantType.ACTIVITY_INTENT_ACTION)
        ...
        /**
         * Activity Action: Show screen for controlling which apps have access on volume
         * directories.
         * <p>
         * Input: Nothing.
         * <p>
         * Output: Nothing.
         * <p>
         * Applications typically use this action to ask the user to revert the "Do not
         * ask again"
         * status of directory access requests made by
         * {@link android.os.storage.StorageVolume#createAccessIntent(String)}.
         * 
         * @deprecated use {@link #ACTION_APPLICATION_DETAILS_SETTINGS} to manage
         *             storage permissions
        ...
        /**
         * Activity Action: Show screen that let user select enable (or disable) Content
         * Capture.
         * <p>
         * Input: Nothing.
         *
        ...
        /**
         * Activity Action: Show screen that let user manage how Android handles URL
         * resolution.
         * <p>
         * Input: Nothing.
         * <p>
        ...
        /**
         * Activity Action: Show screen that let user select enable (or disable)
         * tethering.
         * <p>
         * Input: Nothing.
         * <p>
         ...
         * Need to specify {@link #EXTRA_ENABLE_MMS_DATA_REQUEST_REASON} and
         * {@link #EXTRA_SUB_ID}.
         *
         * @hide
         */
        ...
        /**
         * Integer value that specifies the reason triggering enable MMS data
         * notification.
         * This must be passed as an extra field to the
         * {@link #ACTION_ENABLE_MMS_DATA_REQUEST}.
        ...
        /**
         * @hide - Private call() method on SettingsProvider to read from 'config'
         *       table.
         */
         ...
         *       the settings generation in order to cache values locally. If this key
         *       is
         *       mapped to a <code>null</code> string extra in the request bundle, the
         *       response
         *       bundle will contain the same key mapped to a parcelable extra which
         *       would be
         *       an {@link android.util.MemoryIntArray}. The response will also contain
         *       an
         *       integer mapped to the {@link #CALL_METHOD_GENERATION_INDEX_KEY} which
         *       is the
         *       index in the array clients should use to lookup the generation. For
         *       efficiency
         *       the caller should request the generation tracking memory array only if
         *       it
         ...
         *       to look up the generation id of the backing table. The value is an
         *       integer.
         *
        ...
        /**
         * @hide - RemoteCallback monitor callback argument extra to the fast-path
         *       call()-based requests
         */
        ...
        /**
         * @hide - Private call() method to write to and delete from the 'configuration'
         *       table
         */
        ...
        /**
         * @hide - Private call() method to disable / re-enable syncs to the
         *       'configuration' table
         */
        public static final String CALL_METHOD_SET_SYNC_DISABLED_CONFIG = "SET_SYNC_DISABLED_config";

        /**
         * @hide - Private call() method to return whether syncs are disabled for the
         *       'configuration'
         *       table
         */
        ...
        /**
         * @hide - Private call() method to register monitor callback for
         *       'configuration' table
         */
         ...
         * syncable content
         * provider's authorities as a String[]. This field is used by some intents to
         * alter the
         * behavior of the called activity.
         * <p>
         * Example: The {@link #ACTION_ADD_ACCOUNT} intent restricts the account types
         * available based
         ...
         * This can be passed as an extra field in an Activity Intent with one or more
         * account types
         * as a String[]. This field is used by some intents to alter the behavior of
         * the called
         * activity.
         * <p>
         * Example: The {@link #ACTION_ADD_ACCOUNT} intent restricts the account types
         ...
         * InputDeviceIdentifier. This field is used by some activities to jump straight
         * into the
         * settings for the given device.
         * <p>
         * Example: The {@link #ACTION_INPUT_METHOD_SETTINGS} intent opens the keyboard
         * layout
         ...
         * {@link #ACTION_VOICE_CONTROL_AIRPLANE_MODE}
         ...
         * <p>
         * This can be passed as an extra field to the
         * {@link #ACTION_VOICE_CONTROL_BATTERY_SAVER_MODE}
         * intent as a boolean to indicate if it should be enabled.
         */
         ...
         * <p>
         * This can be passed as an extra field to the
         * {@link #ACTION_VOICE_CONTROL_DO_NOT_DISTURB_MODE}
         * intent as a boolean to indicate if it should be enabled.
         */
         ...
         * <p>
         * This can be passed as an extra field to the
         * {@link #ACTION_MONITORING_CERT_INFO}
        ...
        public static class NameValueTable implements BaseColumns {
                ...
                // A flag indicating whether the current value of a setting should be preserved
                // during
                // restore.
                /** @hide */
        ...
        private static class NameValueCache {
                ...
                public String getStringForUser(ContentResolver cr, String name, final int userHandle) {
                        // Check if the target settings key is readable. Reject if the caller is not
                        // system and
                        // is trying to access a settings key defined in the Settings.Secure,
                        // Settings.System or
                        // Settings.Global and is not annotated as @Readable.
                        // Notice that a key string that is not defined in any of the Settings.* classes
                        // will
                        ...
                        if (!isCallerExemptFromReadableRestriction() && mAllFields.contains(name)) {
                                if (!mReadableFields.contains(name)) {
                                        throw new SecurityException(
                                                        "Settings key: <" + name
                                                                        + "> is not readable. From S+, settings keys "
                                        ...
                                        if (mReadableFieldsWithMaxTargetSdk.containsKey(name)) {
                                                ...
                                                final boolean targetSdkCheckOk = application != null
                                                                ...
                                                                && application.getApplicationInfo().targetSdkVersion <= maxTargetSdk;
                                                if (!targetSdkCheckOk) {
                                                        throw new SecurityException(
                                                                        "Settings key: <" + name
                                                                                        + "> is only readable to apps with "
                        ...
                        if (mCallGetCommand != null) {
                                try {
                                        ...
                                        if (Settings.isInSystemServer() && Binder.getCallingUid() != Process.myUid()) {
                                                ...
                                                b = cp.call(cr.getAttributionSource(),
                                                                mProviderHolder.mUri.getAuthority(), mCallGetCommand,
                                                                name, args);
                                        }
                                        if (b != null) {
                                                        ...
                                                        synchronized (NameValueCache.this) {
                                                                if (needsGenerationTracker) {
                                                                        ...
                                                                        if (array != null && index >= 0) {
                                                                                ...
                                                                                mGenerationTracker = new GenerationTracker(
                                                                                                array, index,
                                                                                                generation, () -> {
                                                                                                        synchronized (NameValueCache.this) {
                                                                ...
                                                                if (mGenerationTracker != null
                                                                                && currentGeneration == mGenerationTracker
                ...
                private static boolean isCallerExemptFromReadableRestriction() {
                        ...
                        final boolean isTestOnly = (applicationInfo.flags & ApplicationInfo.FLAG_TEST_ONLY) != 0;
                ...
                public ArrayMap<String, String> getStringsForPrefix(ContentResolver cr, String prefix,
                                                ...
                                                if (prefixCached) {
                                                        if (!names.isEmpty()) {
                                                                ...
                                                                for (int i = 0; i < mValues.size(); ++i) {
                                                                        ...
                                                                        // Explicitly exclude the prefix as it is only
                                                                        // there to
                        ...
                        try {
                                ...
                                Map<String, String> flagsToValues = (HashMap) b
                                                .getSerializable(Settings.NameValueTable.VALUE);
                                ...
                                synchronized (NameValueCache.this) {
                                        ...
                                        if (mGenerationTracker != null && currentGeneration == mGenerationTracker
                                                        .getCurrentGeneration()) {
         ...
         * @return true if the specified context can draw on top of other apps, false
         *         otherwise
         */
        public static boolean canDrawOverlays(Context context) {
                return Settings.isCallingPackageAllowedToDrawOverlays(context, Process.myUid(),
                                ...
                                || context.checkSelfPermission(
                                                Manifest.permission.SYSTEM_APPLICATION_OVERLAY) == PackageManager.PERMISSION_GRANTED;
        }
        ...
        public static final class System extends NameValueTable {
                ...
                /**
                 * Store a name/value pair into the database. Values written by this method will
                 * be
                 ...
                 *                                  name can't be found or the setting value is
                 *                                  not an integer.
                 *
                ...
                public static void adjustConfigurationForUser(ContentResolver cr, Configuration outConfig,
                        ...
                        if (localeValue != null) {
                                ...
                                // Do not update configuration with emtpy settings since we need to take over
                                // the
                                // locale list of previous user if the settings value is empty. This happens
                                // when a
                                // new user is created.
                ...
                public static boolean putConfigurationForUser(ContentResolver cr, Configuration config,
                        ...
                        return Settings.System.putFloatForUser(cr, FONT_SCALE, config.fontScale, userHandle) &&
                                        Settings.System.putStringForUser(
                                                        cr, SYSTEM_LOCALES, config.getLocales().toLanguageTags(),
                                                        userHandle,
                                                        DEFAULT_OVERRIDEABLE_BY_RESTORE);
                }

                /**
                 * Convenience function for checking if settings should be overwritten with
                 * config changes.
                 * 
                ...
                /**
                 * @deprecated Use {@link android.provider.Settings.Global#AIRPLANE_MODE_ON}
                 *             instead
                 */
                @Deprecated
                ...
                /**
                 * @deprecated Use {@link android.provider.Settings.Global#RADIO_BLUETOOTH}
                 *             instead
                 */
                @Deprecated
                ...
                /**
                 * @deprecated Use {@link android.provider.Settings.Global#AIRPLANE_MODE_RADIOS}
                 *             instead
                 */
                @Deprecated
                ...
                @Deprecated
                @UnsupportedAppUsage
                public static final String AIRPLANE_MODE_TOGGLEABLE_RADIOS = Global.AIRPLANE_MODE_TOGGLEABLE_RADIOS;

                /**
                 * @deprecated Use {@link android.provider.Settings.Global#WIFI_SLEEP_POLICY}
                 *             instead
                 */
                @Deprecated
                 ...
                 */
                @Deprecated
                public static final int WIFI_SLEEP_POLICY_NEVER_WHILE_PLUGGED = Global.WIFI_SLEEP_POLICY_NEVER_WHILE_PLUGGED;
                 ...
                 * To update system locale, use
                 * {@link com.android.internal.app.LocalePicker#updateLocales}
                 * instead.
                 * 
                 * @hide
                 */
                ...
                /**
                 * Hint to decide whether restored vendor color modes are compatible with the
                 * new device. If
                 ...
                 * 
                 * @deprecated Use {@link android.provider.Settings.Secure#ADAPTIVE_SLEEP}
                 *             instead.
                 * @hide
                 */
                @Deprecated
                 ...
                 * stream type's bit should be set to 1 if it should be muted when a mute
                 * request
                 * is received.
                 */
                @Readable
                 ...
                 *
                 * Not all devices are capable of changing their vibration intensity; on these
                 * devices
                 * there will likely be no difference between the various vibration intensities
                 * except for
                 ...
                 *
                 * Not all devices are capable of changing their feedback intensity; on these
                 * devices
                 * there will likely be no difference between the various vibration intensities
                 * except for
                 * intensity 0 (off) and the rest.
                 ...
                 *       AudioSystem.NUM_STREAM_TYPES, and has empty strings for stream types
                 *       whose volumes
                 *       are never persisted.
                 */
                ...
                /**
                 * Scaling factor for Animator-based animations. This affects both the start
                 * delay and
                 * duration of all such animations. Setting to 0 will cause animations to end
                 * immediately.
                 ...
                 * When {@link #ACCELEROMETER_ROTATION} is zero and no on-screen Activity
                 * expresses a
                 ...
                 * may be
                 * unavailable for other reasons). If 1, then the rotation lock toggle is
                 * hidden.
                 *
                 * @hide
                 */
                 ...
                 * ICS.
                 * It was about AudioManager's setting and thus affected all the applications
                 * which
                ...
                /**
                 * Whether the audible DTMF tones are played by the dialer when dialing. The
                 * value is
                 * boolean (1 or 0).
                 */
                @Readable
                ...
                /**
                 * Whether the sounds effects (key clicks, lid open ...) are enabled. The value
                 * is
                 * boolean (1 or 0).
                 */
                @Readable
                ...
                /**
                 * @deprecated Use SIP_ALWAYS or SIP_ADDRESS_ONLY instead. Formerly used to
                 *             indicate that
                 *             the user should be prompted each time a call is made whether it
                 *             should be placed using
                 *             SIP. The {@link com.android.providers.settings.DatabaseHelper}
                 *             replaces this with
                 *             SIP_ADDRESS_ONLY.
                 * @hide
                 */
                 ...
                 * This is an integer value in a range between -7 and +7, so there are 15
                 * possible values.
                 * -7 = slowest
                 * 0 = default speed
                 * +7 = fastest
                ...
                /**
                 * Setting to determine whether or not to show the battery percentage in the
                 * status bar.
                 ...
                 * When enabled, requires more management by user over application playback
                 * activity,
                ...
                /**
                 * Whether allowing pocket service to register sensors and dispatch
                 * informations.
                 * 0 = disabled
                 * 1 = enabled
                 * 
                ...
                * Whether to wake the display when plugging or unplugging the charger
                 ...
                 *
                 * All settings in {@link LEGACY_RESTORE_SETTINGS} array *must* have a non-null
                 * validator,
                ...
                /**
                 * Whether the torch launch gesture to double tap or long press the power button
                 * when the
                ...
                /**
                 * These entries should be cloned from this profile's parent only if the
                 * dependency's
                 * value is true ("1")
                 *
                ...
                /**
                 * @deprecated Use {@link android.provider.Settings.Global#DEVICE_PROVISIONED}
                 *             instead
                 */
                @Deprecated
                ...
                /**
                 * @deprecated Use {@link android.provider.Settings.Global#NETWORK_PREFERENCE}
                 *             instead
                 */
                @Deprecated
                 ...
                 */
                @Deprecated
                public static final String PARENTAL_CONTROL_REDIRECT_URL = Secure.PARENTAL_CONTROL_REDIRECT_URL;

                /**
                 * @deprecated Use {@link android.provider.Settings.Secure#SETTINGS_CLASSNAME}
                 *             instead
                 */
                @Deprecated
                ...
                /**
                 * @deprecated Use {@link android.provider.Settings.Global#USE_GOOGLE_MAIL}
                 *             instead
                 */
                @Deprecated
                 ...
                 */
                @Deprecated
                public static final String WIFI_MOBILE_DATA_TRANSITION_WAKELOCK_TIMEOUT_MS = Global.WIFI_MOBILE_DATA_TRANSITION_WAKELOCK_TIMEOUT_MS;
                 ...
                 */
                @Deprecated
                public static final String WIFI_NETWORKS_AVAILABLE_NOTIFICATION_ON = Global.WIFI_NETWORKS_AVAILABLE_NOTIFICATION_ON;
                 ...
                 */
                @Deprecated
                public static final String WIFI_NETWORKS_AVAILABLE_REPEAT_DELAY = Global.WIFI_NETWORKS_AVAILABLE_REPEAT_DELAY;
                ...
                @Deprecated
                @Readable
                public static final String WIFI_WATCHDOG_ACCEPTABLE_PACKET_LOSS_PERCENTAGE = Secure.WIFI_WATCHDOG_ACCEPTABLE_PACKET_LOSS_PERCENTAGE;
                ...
                @Deprecated
                @Readable
                public static final String WIFI_WATCHDOG_BACKGROUND_CHECK_DELAY_MS = Secure.WIFI_WATCHDOG_BACKGROUND_CHECK_DELAY_MS;
                ...
                @Deprecated
                @Readable
                public static final String WIFI_WATCHDOG_BACKGROUND_CHECK_ENABLED = Secure.WIFI_WATCHDOG_BACKGROUND_CHECK_ENABLED;
                ...
                @Deprecated
                @Readable
                public static final String WIFI_WATCHDOG_BACKGROUND_CHECK_TIMEOUT_MS = Secure.WIFI_WATCHDOG_BACKGROUND_CHECK_TIMEOUT_MS;
                ...
                @Deprecated
                @Readable
                public static final String WIFI_WATCHDOG_INITIAL_IGNORED_PING_COUNT = Secure.WIFI_WATCHDOG_INITIAL_IGNORED_PING_COUNT;
                ...
                /**
                 * @deprecated Use {@link android.provider.Settings.Global#WIFI_WATCHDOG_ON}
                 *             instead
                 */
                @Deprecated
                ...
                @Deprecated
                @Readable
                public static final String WIFI_WATCHDOG_PING_TIMEOUT_MS = Secure.WIFI_WATCHDOG_PING_TIMEOUT_MS;
        ...
        public static final class Secure extends NameValueTable {
                        ...
                        if (MOVED_TO_LOCK_SETTINGS.contains(name)) {
                                ...
                                if (sLockSettings != null && !sIsSystemProcess) {
                                        ...
                                        boolean isPreMnc = application != null
                                                        && application.getApplicationInfo() != null
                                                        && application.getApplicationInfo().targetSdkVersion <= VERSION_CODES.LOLLIPOP_MR1;
                                        if (isPreMnc) {
                                                try {
                 ...
                 * @param tag      Optional tag which should be associated with the settings to
                 *                 reset.
                 *
                ...
                /**
                 *
                 * Reset the settings to their defaults for a given user with a specific mode.
                 * The
                 * optional tag argument is valid only for {@link #RESET_MODE_PACKAGE_DEFAULTS}
                 * allowing resetting the settings made by a package and associated with the
                 * tag.
                 *
                 * @param resolver   Handle to the content resolver.
                 * @param tag        Optional tag which should be associated with the settings
                 *                   to reset.
                ...
                public static void resetToDefaultsAsUser(@NonNull ContentResolver resolver,
                        ...
                        try {
                                ...
                                cp.call(resolver.getAttributionSource(),
                                                sProviderHolder.mUri.getAuthority(), CALL_METHOD_RESET_SECURE, null,
                                                arg);
                        } catch (RemoteException e) {
                 ...
                 */
                @Deprecated
                public static final String DEVELOPMENT_SETTINGS_ENABLED = Global.DEVELOPMENT_SETTINGS_ENABLED;
                 ...
                 * These
                 * locations and status values override actual location and status information
                 * generated
                 ...
                 *
                 * <p class="note">
                 * <strong>Note:</strong> For apps that were installed
                 ...
                 *
                 * <p class="note">
                 * <strong>Note:</strong> If the caller is an Instant App the ID is scoped
                 * to the Instant App, it is generated when the Instant App is first installed
                 * and reset if
                ...
                /**
                 * The {@link android.view.inputmethod.InputMethodInfo.InputMethodInfo#getId()
                 * ID} of the
                 * default voice input method.
                 * <p>
                 * This stores the last known default voice IME. If the related system config
                 * value changes,
                 * this is reset by InputMethodManagerService.
                 * <p>
                 * This IME is not necessarily in the enabled IME list. That state is still
                 * stored in
                ...
                /**
                 * Boolean indicating if the dark mode dialog shown on first toggle has been
                 * seen.
                 *
                 * @hide
                 */
                 ...
                 * {@link android.service.autofill.UserData#getMaxUserDataSize()}.
                 *
                 * @hide
                 */
                @SystemApi
                ...
                /**
                 * Defines value returned by
                 * {@link android.service.autofill.UserData#getMaxValueLength()}.
                 *
                 * @hide
                 */
                @SystemApi
                ...
                /**
                 * Defines value returned by
                 * {@link android.service.autofill.UserData#getMinValueLength()}.
                 *
                 * @hide
                 */
                @SystemApi
                 ...
                 *
                 * <p>
                 * If this is true, then any attempts to begin setup again should result in
                 * factory reset
                 *
                 * @hide
                 */
                 ...
                 * Secure FRP mode is enabled when the device is under FRP. On solving of FRP
                 * challenge,
                ...
                /**
                 * Indicates that the user has snoozed personalization and will complete it
                 * later.
                 * One of the possible states for {@link #USER_SETUP_PERSONALIZATION_STATE}.
                 *
                 * @hide
                ...
                /**
                 * Whether the current user has been set up via setup wizard (0 = false, 1 =
                 * true)
                ...
                /**
                 * The prefix for a category name that indicates whether a suggested action from
                 * that
                 ...
                 * <p>
                 * The setting only determines if the platform will attempt to release
                ...
                /**
                 * Whether to show the IME when a hard keyboard is connected. This is a boolean
                 * that
                ...
                /**
                 * Whether to block networking outside of VPN connections while always-on is
                 * set.
                 * 
                ...
                /**
                 * Comma separated list of packages that are allowed to access the network when
                 * VPN is in
                 ...
                 * 
                 * @deprecated Starting from {@link android.os.Build.VERSION_CODES#O}, apps
                 *             should use
                ...
                /**
                 * A flag to tell
                 * {@link com.android.server.devicepolicy.DevicePolicyManagerService} that
                 * the default for {@link #INSTALL_NON_MARKET_APPS} is reversed for this user on
                 * OTA. So it
                 * can set the restriction
                 * {@link android.os.UserManager#DISALLOW_INSTALL_UNKNOWN_SOURCES}
                 * on behalf of the profile owner if needed to make the change transparent for
                 * profile
                 * owners.
                 *
                 * @hide
                ...
                /**
                 * Comma-separated list of location providers that are enabled. Do not rely on
                 * this value
                 * being present or correct, or on ContentObserver notifications on the
                 * corresponding Uri.
                 *
                 * @deprecated This setting no longer exists from Android S onwards as it no
                 *             longer is
                 *             capable of realistically reflecting location settings. Use {@link
                 *             LocationManager#isProviderEnabled(String)} or
                 *             {@link LocationManager#isLocationEnabled()}
                 *             instead.
                 */
                @Deprecated
                @Readable
                ...
                /**
                 * The current location mode of the device. Do not rely on this value being
                 * present or on
                 * ContentObserver notifications on the corresponding Uri.
                 *
                 * @deprecated The preferred methods for checking location mode and listening
                 *             for changes
                ...
                /**
                 * This mode no longer has any distinct meaning, but is interpreted as the
                 * location mode is
                 * on.
                 *
                 ...
                 *
                 * See {@link android.app.time.TimeManager#getTimeZoneCapabilitiesAndConfig} for
                 * access.
                 * See {@link android.app.time.TimeManager#updateTimeZoneConfiguration} to
                 * update.
                 * 
                 * @hide
                 */
                ...
                /**
                 * The accuracy in meters used for coarsening location for clients with only the
                 * coarse
                 * location permission.
                 *
                 * @hide
                 ...
                 *
                 * @deprecated Use {@link android.app.KeyguardManager} to determine the state
                 *             and security
                 *             level of the keyguard. Accessing this setting from an app that is
                 *             targeting
                 *             {@link VERSION_CODES#M} or later throws a
                ...
                /**
                 * Indicates whether the user has allowed notifications to be shown atop a
                 * securely locked
                ...
                /**
                 * When set by a user, allows notification remote input atop a securely locked
                 * screen
                ...
                /**
                 * Indicates which clock face to show on lock screen and AOD formatted as a
                 * serialized
                ...
                /**
                 * Setting specifying if the accessibility shortcut dialog has been shown to
                 * this user.
                 * 
                 * @hide
                 */
                ...
                /**
                 * Setting specifying the accessibility services, accessibility shortcut
                 * targets,
                 * or features to be toggled via the accessibility shortcut.
                 *
                 * <p>
                 * This is a colon-separated string list which contains the flattened
                 * {@link ComponentName} and the class name of a system class implementing a
                 * supported
                 ...
                 * {@link ComponentName} or the class name of a system class implementing a
                 * supported
                 * accessibility feature.
                 * 
                 * @hide
                ...
                /**
                 * The system class name of magnification controller which is a target to be
                 * toggled via
                 ...
                 * Else if non-negative, turning on dnd manually will last for this many
                 * minutes.
                ...
                /**
                 * If nonzero, will show the zen upgrade notification when the user toggles DND
                 * on/off.
                 * 
                 * @hide
                 */
                ...
                /**
                 * Whether the in call notification is enabled to play sound during calls. The
                 * value is
                 * boolean (1 or 0).
                 * 
                 * @hide
                 ...
                 *
                 * <p>
                 * This value can be negative. To display bolded text, the adjustment used is
                 * 300,
                 ...
                 *
                 * @deprecated The speaking of passwords is controlled by individual
                 *             accessibility services.
                 *             Apps should ignore this setting and provide complete information
                 *             to accessibility
                 *             at all times, which was the behavior when this value was
                 *             {@code true}.
                 */
                @Deprecated
                @Readable
                ...
                /**
                 * Setting that specifies whether the display magnification is enabled via a
                 * system-wide
                 * triple tap gesture. Display magnifications allows the user to zoom in the
                 * display content
                 * and is targeted to low vision users. The current magnification scale is
                 * controlled by
                 ...
                 * Setting that specifies whether the display magnification is enabled via a
                 * shortcut
                 * affordance within the system's navigation area. Display magnifications allows
                 * the user to
                 * zoom in the display content and is targeted to low vision users. The current
                 * magnification scale is controlled by
                 * {@link #ACCESSIBILITY_DISPLAY_MAGNIFICATION_SCALE}.
                 *
                 * @deprecated Use {@link #ACCESSIBILITY_BUTTON_TARGETS} instead.
                 *             {@link #ACCESSIBILITY_BUTTON_TARGETS} holds the magnification
                 *             system class name
                ...
                /**
                 * Setting that specifies what mode the soft keyboard is in (default or hidden).
                 * Can be
                 ...
                 * <li>a valid index of
                 * {@link android.view.accessibility.CaptioningManager.CaptionStyle#PRESETS}
                 * </ul>
                 *
                 * @see java.util.Locale#toString
                 * @hide
                 ...
                 * perform. Valid values are defined in AccessibilityManager and Settings
                 * arrays.xml:
                ...
                /**
                 * Setting that specifies whether automatic click when the mouse pointer stops
                 * moving is
                 * enabled.
                 *
                 * @hide
                ...
                /**
                 * Integer setting specifying amount of time in ms the mouse pointer has to stay
                 * still
                ...
                /**
                 * Whether or not larger size icons are used for the pointer of mouse/trackpad
                 * for
                 * accessibility.
                 * (0 = false, 1 = true)
                 * 
                ...
                /**
                 * The duration in milliseconds between the first tap's up event and the second
                 * tap's
                ...
                /**
                 * Setting that specifies whether Reduce Bright Colors, or brightness dimming by
                 * color
                ...
                /**
                 * Setting that specifies the level of Reduce Bright Colors in intensity. The
                 * range is
                 * [0, 100].
                 *
                 * @hide
                ...
                /**
                 * Setting that specifies whether Reduce Bright Colors should persist across
                 * reboots.
                 *
                 * @hide
                 */
                 ...
                 *
                 * N and beyond uses {@link #DISABLED_PRINT_SERVICES}. But this might be used in
                 * an upgrade
                 * from pre-N.
                 *
                 * @hide
                 ...
                 *             Sandwich release. Apps should never need to read this setting
                 *             directly,
                ...
                /**
                 * A comma-separated list of SSIDs for which the Wi-Fi watchdog should be
                 * enabled.
                 * 
                 * @deprecated This setting is not used.
                 */
                ...
                /**
                 * The number of milliseconds to hold on to a PendingIntent based request. This
                 * delay gives
                 * the receivers of the PendingIntent an opportunity to make a new network
                 * request before
                ...
                /**
                 * User-selected RTT mode. When on, outgoing and incoming calls will be answered
                 * as RTT
                ...
                /**
                 * Indicates the version for which the setup wizard was last shown. The version
                 * gets
                ...
                /**
                 * The number of suggestions GlobalSearch will ask each non-web search source
                 * for.
                 * 
                 * @hide
                 */
                ...
                /**
                 * The number of suggestions the GlobalSearch will ask the web search source
                 * for.
                 * 
                 * @hide
                 */
                ...
                /**
                 * The maximum number of milliseconds that GlobalSearch shows the previous
                 * results
                ...
                /**
                 * Whether or not a notification is displayed on UMS host detection. (0 = false,
                 * 1 = true)
                 * 
                 * @hide
                 */
                ...
                /**
                 * Whether or not a notification is displayed while UMS is enabled. (0 = false,
                 * 1 = true)
                 * 
                 * @hide
                 */
                ...
                /**
                 * The {@link ComponentName} string of the service to be used as the voice
                 * recognition
                 * service.
                 *
                 * @hide
                ...
                /**
                 * The {@link ComponentName} string of the selected spell checker service which
                 * is
                ...
                /**
                 * {@link android.view.textservice.SpellCheckerSubtype#hashCode()} of the
                 * selected subtype
                 * of the selected spell checker service which is one of the services managed by
                 * the text
                 * service manager.
                 *
                 * @hide
                 ...
                 * <b>Values:</b><br/>
                 * 1 - The Power button turns off the screen and locks the device. (Default
                 * behavior)<br/>
                 ...
                 * <p>
                 * Values:
                 * 0 - Not allowed. Any preferences set through the
                 * Window.setPreferMinimalPostProcessing
                 * API will be ignored.
                 * 1 - Allowed. Any preferences set through the
                 * Window.setPreferMinimalPostProcessing API
                ...
                /**
                 * Allow only refresh rate switching between modes in the same configuration
                 * group.
                 * This way only switches without visual interruptions for the user will be
                 * allowed.
                 *
                 * @see #MATCH_CONTENT_FRAME_RATE
                 * @hide
                ...
                /**
                 * Allow refresh rate switching between all refresh rates even if the switch
                 * will have
                 ...
                 * 1 - Switch refresh rates only when it can be done seamlessly. (Default
                 * behaviour)
                 * 2 - Always prefer refresh rate switching even if it's going to have visual
                 * interruptions
                 * for the user.
                 *
                 ...
                 * @hide
                 */
                public static final int INCALL_POWER_BUTTON_BEHAVIOR_DEFAULT = INCALL_POWER_BUTTON_BEHAVIOR_SCREEN_OFF;
                 ...
                 * @hide
                 */
                public static final int INCALL_BACK_BUTTON_BEHAVIOR_DEFAULT = INCALL_BACK_BUTTON_BEHAVIOR_NONE;
                ...
                /**
                 * Gesture that wakes up the display, toggling between {@link Display.STATE_OFF}
                 * and
                ...
                /**
                 * Whether the device should suppress the current doze configuration and disable
                 * dozing.
                 * 
                 * @hide
                 */
                ...
                /**
                 * Number of touch interactions to pause media when a "Motion Sense" gesture
                 * could
                 * have been used.
                 * 
                 * @hide
                ...
                /**
                 * Toggle to enable/disable for the apps to use the Ui translation for Views.
                 * The value
                ...
                /**
                 * The current night mode that has been overridden to turn on by the system.
                 * Owned
                 * and controlled by UiModeManagerService. Constants are as per
                 * UiModeManager.
                 * 
                ...
                /**
                 * The current night mode that has been overridden to turn off by the system.
                 * Owned
                 * and controlled by UiModeManagerService. Constants are as per
                 * UiModeManager.
                 * 
                 ...
                 * battery, or upon dock insertion (if SCREENSAVER_ACTIVATE_ON_DOCK is set to
                 * 1).
                 * 
                 * @hide
                 */
                ...
                /**
                 * Specifies the package name currently configured to be the default dialer
                 * application
                 * 
                 * @hide
                 */
                ...
                /**
                 * Specifies the component name currently configured to be the default call
                 * screening
                 * application
                 * 
                 * @hide
                ...
                /**
                 * Specifies the package name currently configured to be the emergency
                ...
                /**
                 * Specifies whether the current app context on scren (assist data) will be sent
                 * to the
                ...
                /**
                 * Specifies whether a screenshot of the screen contents will be sent to the
                 * assist
                ...
                /**
                 * Specifies whether the screen will show an animation if screen contents are
                 * sent to the
                 * assist application (active voice interaction service).
                 *
                 * Note that the disclosure will be forced for third-party assistants or if the
                 * device
                ...
                /**
                 * Control if rotation suggestions are sent to System UI when in rotation locked
                 * mode.
                 * Done to enable screen rotation while the the screen rotation is locked.
                 * Enabling will
                 * poll the accelerometer in rotation locked mode.
                 *
                 * If 0, then rotation suggestions are not sent to System UI. If 1, suggestions
                 * are sent.
                 *
                 * @hide
                 */
                 ...
                 * @hide
                 */
                public static final int SHOW_ROTATION_SUGGESTIONS_DEFAULT = SHOW_ROTATION_SUGGESTIONS_ENABLED;

                /**
                 * The number of accepted rotation suggestions. Used to determine if the user
                 * has been
                ...
                /**
                 * Read only list of the service components that the current user has explicitly
                 * allowed to
                ...
                /**
                 * Read only list of the packages that the current user has explicitly allowed
                 * to
                ...
                /**
                 * Defines whether managed profile ringtones should be synced from it's parent
                 * profile
                 * <p>
                 ...
                 * This might
                 * apply to users that are already familiar with the environment or temporary
                 * users.
                 * <p>
                ...
                /**
                 * List of custom TV input labels. This is a string containing <TV input id,
                 * custom name>
                 * pairs. TV input id and custom name are encoded by
                 * {@link android.net.Uri#encode(String)}
                 ...
                 *
                 * <p>
                 * The value is boolean (1 or 0), where 1 means non-system TV inputs are
                 * allowed,
                 * and 0 means non-system TV inputs are not allowed.
                 *
                 * <p>
                 * Devices such as sound bars may have changed the system property
                 * allow_third_party_inputs
                 * to false so the TV Application only uses HDMI and other built in inputs. This
                 * setting
                 * allows user to override the default and have the TV Application use third
                 * party TV inputs
                ...
                /**
                 * Whether automatic routing of system audio to USB audio peripheral is
                 * disabled.
                 ...
                 * be longer than {@link Settings.System#SCREEN_OFF_TIMEOUT} as otherwise the
                 * device
                ...
                /**
                 * The timeout in milliseconds before the device goes to sleep due to user
                 * inattentiveness,
                 * even if the system is holding wakelocks. It should generally be longer than
                 * {@code
                 * config_attentiveWarningDuration}, as otherwise the device will show the
                 * attentive
                 * warning constantly. Small timeouts are discouraged, as they will cause the
                 * device to
                 ...
                 * or an activity that handles ACTION_ASSIST, or empty which means using the
                 * default
                 * handling.
                 *
                 * <p>
                 * This should be set indirectly by setting the {@link
                ...
                /**
                 * Whether the camera double twist gesture to flip between front and back mode
                 * should be
                 * enabled.
                 *
                 * @hide
                ...
                /**
                 * Whether or not the smart camera lift trigger that launches the camera when
                 * the user moves
                ...
                /**
                 * Whether or not the flashlight (camera torch mode) is available required to
                 * turn
                 * on flashlight.
                 *
                 * @hide
                ...
                /**
                 * Whether or not face unlock requires attention. This is a cached value, the
                 * source of
                ...
                /**
                 * Whether or not face unlock requires a diverse set of poses during enrollment.
                 * This is a
                ...
                /**
                 * A String representing the LocalDateTime when Night display was last
                 * activated. Use to
                 * decide whether to apply the current activated state after a reboot or user
                 * change. In
                ...
                /**
                 * Names of the service components that the current user has explicitly allowed
                 * to
                 ...
                 *
                 * One of {@link #VR_DISPLAY_MODE_LOW_PERSISTENCE} or
                 * {@link #VR_DISPLAY_MODE_OFF}.
                 *
                 * @hide
                 */
                @Readable
                ...
                /**
                 * The latest SDK version that CarrierAppUtils#disableCarrierAppsUntilPrivileged
                 * has been
                 * executed for.
                 *
                 * <p>
                 * This is used to ensure that we only take one pass which will disable apps
                 * that are not
                 * privileged (if any). From then on, we only want to enable apps (when a
                 * matching SIM is
                 * inserted), to avoid disabling an app that the user might actively be using.
                 *
                 * <p>
                 * Will be set to {@link android.os.Build.VERSION#SDK_INT} once executed. Note
                 * that older
                ...
                /**
                 * Whether or not the automatic storage manager is enabled and should run on the
                 * device.
                 *
                 * @hide
                 */
                ...
                /**
                 * How many days of information for the automatic storage manager to retain on
                 * the device.
                 *
                 * @hide
                 */
                ...
                /**
                 * Default number of days of information for the automatic storage manager to
                 * retain.
                 *
                 * @hide
                 */
                ...
                /**
                 * If the automatic storage manager has been disabled by policy. Note that this
                 * doesn't
                 * mean that the automatic storage manager is prevented from being re-enabled --
                 * this only
                 ...
                 *
                 * 0 indicates disabled and 1 indicates enabled. A non existent value should be
                 * treated as
                 * enabled.
                 *
                 * @deprecated Controls are migrated to Quick Settings, rendering this
                ...
                /**
                 * Whether power menu content (cards, passes, controls) will be shown when
                 * device is locked.
                 *
                 * 0 indicates hide and 1 indicates show. A non existent value will be treated
                 * as hide.
                 * 
                 * @hide
                 */
                ...
                /**
                 * Has this pairable device been paired or upgraded from a previously paired
                 * system.
                 * 
                 * @hide
                 */
                ...
                /**
                 * When enabled the system will maintain a rolling history of received
                 * notifications. When
                ...
                /**
                 * When enabled, notifications able to bubble will display an affordance
                 * allowing the user
                 * to bubble them.
                ...
                /**
                 * Whether notifications are dismissed by a right-to-left swipe (instead of a
                 * left-to-right
                 * swipe).
                 *
                 * @hide
                ...
                /**
                 * Flag to set if the system should predictively attempt to re-enable Bluetooth
                 * while
                 * the user is driving.
                 * 
                 * @hide
                ...
                /**
                 * Whether the "first time battery saver warning" dialog needs to be shown (0:
                 * default)
                 * or not (1).
                 *
                 * @hide
                ...
                /**
                 * 0 (default) Auto battery saver suggestion has not been suppressed. 1) it has
                 * been
                 * suppressed.
                 * 
                 * @hide
                ...
                /**
                 * List of packages, which data need to be unconditionally cleared before full
                 * restore.
                 * Type: string
                 * 
                 * @hide
                ...
                /**
                 * Map of android.theme.customization.* categories to the enabled overlay
                 * package for that
                 * category, formatted as a serialized {@link org.json.JSONObject}. If there is
                 * no
                 * corresponding package included for a category, then all overlay packages in
                 * that
                 ...
                 * When enabled, media controls in quick settings will populate on boot and
                 * persist if
                ...
                /**
                 * Magnification mode value that is a default value for the magnification
                 * logging feature.
                 * 
                 * @hide
                 */
                ...
                /**
                 * Magnification mode value that is capable of magnifying whole display and
                 * particular
                 * region in a window.
                 * 
                 * @hide
                ...
                /**
                 * Controls magnification capability. Accessibility magnification is capable of
                 * at least one
                ...
                /**
                 * Whether to show the window magnification prompt dialog when the user uses
                 * full-screen
                ...
                /**
                 * Controls the accessibility button mode. System will force-set the value to
                 * {@link
                 * #ACCESSIBILITY_BUTTON_MODE_GESTURE} if {@link #NAVIGATION_MODE} is button;
                 * force-set the
                 * value to {@link ACCESSIBILITY_BUTTON_MODE_NAVIGATION_BAR} if
                 * {@link #NAVIGATION_MODE} is
                ...
                /**
                 * Accessibility button mode value that specifying the accessibility service or
                 * feature to
                ...
                /**
                 * The opacity value for the accessibility floating menu fade out effect, from
                 * 0.0
                ...
                /**
                 * Prompts the user to the Accessibility button is replaced with the floating
                 * menu.
                 * <ul>
                 * <li>0 = disabled</li>
                 * <li>1 = enabled</li>
                ...
                /**
                 * For this device state, no specific auto-rotation lock setting should be
                 * applied.
                 * If the user toggles the auto-rotate lock in this state, the setting will
                 * apply to the
                 ...
                 *
                 * This holds a serialized map using int keys that represent Device States and
                 * value of
                 * {@link DeviceStateRotationLockSetting} representing the rotation lock setting
                 * for that
                 * device state.
                 *
                ...
                /**
                 * Thread-safe method for enabling or disabling a single location provider. This
                 * will have
         ...
         * to all defined users. Applications can read these but are not allowed to
         * write;
        ...
        public static final class Global extends NameValueTable {
                 ...
                 *
                 * @hide
                 *       No longer used. Should be removed once all dependencies have been
                 *       updated.
                 */
                @UnsupportedAppUsage
                @Readable
                ...
                /**
                 * A comma separated list of radios that should to be disabled when airplane
                 * mode
                 * is on, but can be manually reenabled by the user. For example, if RADIO_WIFI
                 * is
                 * added to both AIRPLANE_MODE_RADIOS and AIRPLANE_MODE_TOGGLEABLE_RADIOS, then
                 * Wifi
                 * will be turned off when entering airplane mode, but the user will be able to
                 * reenable
                ...
                /**
                 * A Long representing a bitmap of profiles that should be disabled when
                 * bluetooth starts.
                 ...
                 * Each entry is a partial Bluetooth device address string and an integer
                 * representing
                ...
                /**
                 * Value to specify if the device's UTC system clock should be set
                 * automatically, e.g. using
                 * telephony signals like NITZ, or other sources like GNSS or NTP. 1=yes, 0=no
                 * (manual)
                 */
                @Readable
                ...
                /**
                 * Value to specify if the device's time zone system property should be set
                 * automatically,
                 * e.g. using telephony signals like MCC and NITZ, or other mechanisms like the
                 * location.
                 * 1=yes, 0=no (manual).
                 */
                @Readable
                ...
                /**
                 * Whether to play a sound for dock events, only when an accessibility service
                 * is on.
                 * 
                 * @hide
                 */
                ...
                /**
                 * URI for the "device is trusted" sound, which is played when the device enters
                 * the trusted
                 ...
                 * 
                 * @deprecated Use
                 *             {@link android.provider.Settings.Secure#CHARGING_SOUNDS_ENABLED}
                 *             instead
                 * @hide
                 */
                @Deprecated
                 ...
                 * 
                 * @deprecated Use
                 *             {@link android.provider.Settings.Secure#CHARGING_VIBRATION_ENABLED}
                 * @hide
                 */
                @Deprecated
                public static final String CHARGING_VIBRATION_ENABLED = "charging_vibration_enabled";
                 ...
                 * charger</li>
                 * <li>{@link BatteryManager#BATTERY_PLUGGED_WIRELESS} to stay on for wireless
                 * charger</li>
                 * </ul>
                ...
                /**
                 * The package name for the custom bugreport handler app. This app must be
                 * whitelisted.
                ...
                /**
                 * The user id for the custom bugreport handler app. This is currently used only
                 * by Power
                 * Menu short press.
                 *
                 * @hide
                 ...
                 * seconds to
                 * infer the data activity of mobile network. After a period of no activity on
                 * mobile
                 * networks with length specified by the timeout, an
                 * {@code ACTION_DATA_ACTIVITY_CHANGE}
                 * intent is fired to indicate a transition of network status from "active" to
                 * "idle". Any
                 * subsequent activity on mobile networks triggers the firing of {@code
                 * ACTION_DATA_ACTIVITY_CHANGE} intent indicating transition from "idle" to
                 * "active".
                 *
                 ...
                 * {@code DATA_ACTIVITY_TIMEOUT_MOBILE}
                 ...
                 * number of retries to perform when setting up the initial connection. The
                 * default
                 * value defined in DataConnectionTrackerBase#DEFAULT_MDC_INITIAL_RETRY is
                 * currently 1.
                 * 
                 * @hide
                 */
                 ...
                 *
                 * <p>
                 * An SM-DP+ is used by an LPA (see {@link android.service.euicc.EuiccService})
                 * to
                 * download profiles. If this value is set, the LPA will query this server for
                 * any profiles
                 * available to this device. If any are available, they may be downloaded during
                 * device
                 * provisioning or in settings without needing the user to enter an activation
                 * code.
                 *
                 ...
                 *
                 * <p>
                 * Used to hide eUICC UI from users who have never made use of it and would only
                 * be
                ...
                /**
                 * List of ISO country codes in which eUICC UI is shown. Country codes should be
                 * separated
                 * by comma.
                 *
                 ...
                 *
                 * <p>
                 * Used to hide eUICC UI from users who are currently in countries where no
                 * carriers
                 * support eUICC.
                 *
                 * @hide
                ...
                /**
                 * List of ISO country codes in which eUICC UI is not shown. Country codes
                 * should be
                 * separated by comma.
                 *
                 * Note: if {@link #EUICC_SUPPORTED_COUNTRIES} is empty, then {@link
                ...
                /**
                 * Whether to allow non-resizable apps to be shown in multi-window. The app will
                 * be
                 * letterboxed if the request orientation is not met, and will be shown in
                 * size-compat
                ...
                /**
                 * If true, shadows drawn around the window will be rendered by the system
                 * compositor. If
                 * false, shadows will be drawn by the client by setting an elevation on the
                 * root view and
                ...
                /**
                 * Path to the WindowManager display settings file. If unset, the default file
                 * path will
                 * be used.
                 *
                 * @hide
                 ...
                 * as soon as this is set to true and further activities cannot be launched on
                 * the
                ...
                /**
                 * Indicates whether mobile data should be allowed while the device is being
                 * provisioned.
                ...
                /**
                 * The recommended maximum size, in bytes, of a download that the download
                 * manager should
                 * transfer over a non-wifi connection. Over this size, the use will be warned,
                 * but will
                ...
                /**
                 * Whether HDMI control shall be enabled. If disabled, no CEC/MHL command will
                 * be
                ...
                /**
                 * Controls whether volume control commands via HDMI CEC are enabled. (0 =
                 * false, 1 =
                 * true).
                 *
                 * <p>
                 ...
                 *         Pressed>}</td>
                 * <td>Device does not send volume commands via
                 * {@code <User Control Pressed>}.</td>
                 * </tr>
                 * <tr>
                ...
                /**
                 * Whether HDMI System Audio Control feature is enabled. If enabled, TV will try
                 * to turn on
                 * system audio mode if there's a connected CEC-enabled AV Receiver. Then audio
                 * stream will
                 * be played on AVR instead of TV spaeker. If disabled, the system audio mode
                 * will never be
                 * activated.
                 * 
                 * @hide
                ...
                /**
                 * Whether HDMI Routing Control feature is enabled. If enabled, the switch
                 * device will
                 * route to the correct input source on receiving Routing Control related
                 * messages. If
                ...
                /**
                 * Property to decide which devices the playback device can send a <Standby>
                 * message to
                 * upon going to sleep. It additionally controls whether a playback device
                 * attempts to turn
                 * on the connected Audio system when waking up. Supported values are:
                 * <ul>
                 * <li>{@link HdmiControlManager#POWER_CONTROL_MODE_TV} Upon going to sleep,
                 * device
                 * sends {@code <Standby>} to TV only. Upon waking up, device does not turn on
                 * the Audio
                 * system via {@code <System Audio Mode Request>}.</li>
                 * <li>{@link HdmiControlManager#POWER_CONTROL_MODE_BROADCAST} Upon going to
                 * sleep,
                 * device sends {@code <Standby>} to all devices in the network. Upon waking up,
                 * device
                 * attempts to turn on the Audio system via
                 * {@code <System Audio Mode Request>}.</li>
                 * <li>{@link HdmiControlManager#POWER_CONTROL_MODE_NONE} Upon going to sleep,
                 * device
                 * does not send any {@code <Standby>} message. Upon waking up, device does not
                 * turn on the
                ...
                /**
                 * The interval in milliseconds at which location requests will be throttled
                 * when they are
                ...
                /**
                 * Most frequent location update interval in milliseconds that proximity alert
                 * is allowed
                 * to request.
                 * 
                 * @hide
                ...
                /**
                 * Packages that are whitelisted for background throttling (throttling will not
                 * be applied).
                 * 
                 * @hide
                 */
                ...
                /**
                 * Packages that are whitelisted for ignoring location settings (may retrieve
                 * location even
                ...
                /**
                 * Whether TV will charge the mobile device connected at MHL port. (0 = false, 1
                 * = true)
                 * 
                 * @hide
                 */
                ...
                /**
                 * Which package name to use for network scoring. If null, or if the package is
                 * not a valid
                ...
                /**
                 * Minimum number of samples needed for statistics to be considered meaningful
                 * in the
                 * system DNS resolver.
                 * {@hide}
                 */
                ...
                /**
                 * Maximum number taken into account for statistics purposes in the system DNS
                 * resolver.
                 * {@hide}
                 */
                @Readable
                 ...
                 * {@link #PDP_WATCHDOG_ERROR_POLL_INTERVAL_MS})
                ...
                /**
                 * Used to select TCP's default initial receiver window size in segments -
                 * defaults to a
                 * build config value.
                 * 
                 * @hide
                ...
                /**
                 * Used to require DUN APN on the device or not - defaults to a build config
                 * value
                 ...
                 *
                 * Integer values are interpreted as boolean, and the absence of an explicit
                 * setting
                ...
                /**
                 * Use the old dnsmasq DHCP server for tethering instead of the framework
                 * implementation.
                 *
                 * Integer values are interpreted as boolean, and the absence of an explicit
                 * setting
                ...
                /**
                 * List of certificate (hex string representation of the application's
                 * certificate - SHA-1
                 * or SHA-256) and carrier app package pairs which are whitelisted to prompt the
                 * user for
                 * install when a sim card with matching UICC carrier privilege rules is
                 * inserted. The
                 * certificate is used as a key, so the certificate encoding here must be the
                 * same as the
                ...
                /**
                 * Map of package name to application names. The application names cannot and
                 * will not be
                ...
                /**
                 * Name of the package used as WebView provider (if unset the provider is
                 * instead determined
                 * by the system).
                 * 
                 * @hide
                ...
                /**
                 * The maximum number of notifications shown in 24 hours when switching
                 * networks.
                 * 
                 * @hide
                 */
                ...
                /**
                 * The minimum time in milliseconds between notifications when switching
                 * networks.
                 * 
                 * @hide
                 */
                ...
                /**
                 * Whether to automatically switch away from wifi networks that lose Internet
                 * access.
                 * Only meaningful if config_networkAvoidBadWifi is set to 0, otherwise the
                 * system always
                 * avoids such networks. Valid values are:
                 *
                 * 0: Don't avoid bad wifi, don't prompt the user. Get stuck on bad wifi like
                 * it's 2013.
                ...
                /**
                 * User setting for ConnectivityManager.getMeteredMultipathPreference(). This
                 * value may be
                 * overridden by the system based on device or application state. If null, the
                 * value
                ...
                /**
                 * Default daily multipath budget used by
                 * ConnectivityManager.getMultipathPreference()
                 * on metered networks. This default quota is only used if quota could not be
                 * determined
                ...
                /**
                 * The thresholds of the wifi throughput badging (SD, HD etc.) as a
                 * comma-delimited list of
                 * colon-delimited key-value pairs. The key is the badging enum value defined in
                 * android.net.ScoredNetwork and the value is the minimum sustained network
                 * throughput in
                 ...
                 *             {@link WifiManager#setScanAlwaysAvailable(boolean)} for
                 *             setting the value and {@link WifiManager#isScanAlwaysAvailable()}
                 *             for query.
                 */
                @Deprecated
                @Readable
                ...
                /**
                 * Whether soft AP will shut down after a timeout period when no devices are
                 * connected.
                 *
                 * Type: int (0 for false, 1 for true)
                 * 
                 ...
                 *             setAutoShutdownEnabled(boolean)} for setting the value and
                 ...
                 * 
                 * @hide
                 * @deprecated Use {@link WifiManager#setAutoWakeupEnabled(boolean)} for setting
                 *             the value
                 ...
                 * Note: This should only be used from within
                 * {@link android.net.wifi.WifiMigration} class.
                 *
                 * Type: int (0 for false, 1 for true)
                 * 
                 * @hide
                ...
                /**
                 * Value to specify whether network quality scores and badging should be shown
                 * in the UI.
                 *
                 * Type: int (0 for false, 1 for true)
                 * 
                ...
                /**
                 * Value to specify how long in milliseconds to retain seen score cache curves
                 * to be used
                 ...
                 * 1 = Enabled
                 *
                 * Most readers of this setting should simply check if value == 1 to determine
                 * the
                 * enabled state.
                 * 
                 * @hide
                ...
                /**
                 * Which package name to use for network recommendations. If null, network
                 * recommendations
                 * will neither be requested nor accepted.
                 *
                 * Use {@link NetworkScoreManager#getActiveScorerPackage()} to read this value
                 * and
                ...
                /**
                 * The package name of the application that connect and secures high quality
                 * open wifi
                 * networks automatically.
                 *
                 * Type: string package name or null if the feature is either not provided or
                 * disabled.
                 * 
                 * @hide
                 */
                ...
                /**
                 * The expiration time in milliseconds for the {@link android.net.WifiKey}
                 * request cache in
                 ...
                 * 
                 * @hide
                 * @deprecated Use {@link WifiManager#setScanThrottleEnabled(boolean)} for
                 *             setting the value
                ...
                /**
                 * Settings to allow BLE scans to be enabled even when Bluetooth is turned off
                 * for
                 * connectivity.
                 * 
                 * @hide
                ...
                /**
                 * Setting to enable verbose logging in Wi-Fi; disabled by default, and setting
                 * to 1
                 * will enable it. In the future, additional values may be supported.
                 * 
                 * @hide
                 * @deprecated Use {@link WifiManager#setVerboseLoggingEnabled(boolean)} for
                 *             setting the
                 *             value and {@link WifiManager#isVerboseLoggingEnabled()} for
                 *             query.
                 */
                @Deprecated
                @Readable
                ...
                /**
                 * Setting to enable connected MAC randomization in Wi-Fi; disabled by default,
                 * and
                 * setting to 1 will enable it. In the future, additional values may be
                 * supported.
                 * 
                ...
                /**
                 * This setting controls whether WiFi configurations created by a Device Owner
                 * app
                 * should be locked down (that is, be editable or removable only by the Device
                 * Owner App,
                 * not even by Settings app).
                 * This setting takes integer values. Non-zero values mean DO created
                 * configurations
                 * are locked down. Value of zero means they are not. Default value in the
                 * absence of
                 ...
                 * @hide
                 * @deprecated Use
                 *             {@link WifiP2pManager#setDeviceName(WifiP2pManager.Channel, String,
                ...
                /**
                 * Timeout for ephemeral networks when all known BSSIDs go out of range. We will
                 * disconnect
                 * from an ephemeral network if there is no BSSID for that network with a
                 * non-null score that
                 * has been seen in this time period.
                 *
                 * If this is less than or equal to zero, we use a more conservative behavior
                 * and only check
                 ...
                 * </pre>
                 * 
                 * : only shows this display's own content</li>
                 * <li>
                 * 
                 * <pre>
                 ...
                 * </pre>
                 * 
                 * : supports system decorations</li>
                 * </ul>
                 * </p>
                 * <p>
                 * Example:
                 ...
                 * 213dpi.</li>
                 * <li><code>1920x1080/320,secure;1280x720/213</code>: make two overlays, the
                 * first at
                 * 1080p and secure; the second at 720p.</li>
                 * <li><code>1920x1080/320|3840x2160/640</code>: make one overlay that is
                 * 1920x1080 at
                 * 213dpi by default, but can also be upscaled to 3840x2160 at 640dpi by the
                 * system if the
                 ...
                 * about bytes/packets sent and error rates based on data sampled in this
                 * interval
                 *
                 * @hide
                 */
                ...
                /**
                 * The series of successively longer delays used in retrying to download PAC
                 * file.
                 ...
                 *
                 * @deprecated use CAPTIVE_PORTAL_MODE_IGNORE to disable captive portal
                 *             detection
                 * @hide
                 */
                @Deprecated
                 ...
                 * and HTTPS captive portal detection attemps did not return a conclusive
                 * answer.
                 *
                 * @hide
                 */
                ...
                /**
                 * A comma separated list of URLs used for captive portal detection in addition
                 * to the
                ...
                /**
                 * A list of captive portal detection specifications used in addition to the
                 * fallback URLs.
                 * Each spec has the format url@@/@@statusCodeRegex@@/@@contentRegex. Specs are
                 * separated
                 * by "@@,@@".
                 * 
                 * @hide
                ...
                /**
                 * Whether to use HTTPS for network validation. This is enabled by default and
                 * the setting
                 * needs to be set to 0 to disable it. This setting is a misnomer because
                 * captive portals
                ...
                /**
                 * Which User-Agent string to use in the header of the captive portal detection
                 * probes.
                 * The User-Agent field is unset when this setting has no value
                ...
                /**
                 * The requested Private DNS mode (string), and an accompanying specifier
                 * (string).
                 *
                 * Currently, the specifier holds the chosen provider name when the mode
                 * requests
                ...
                /**
                 * Forced override of the default mode (hardcoded as "automatic", nee
                 * "opportunistic").
                 * This allows changing the default mode without effectively disabling other
                 * modes,
                 * all of which require explicit user action to enable/configure. See also
                 * b/79719289.
                 *
                ...
                /**
                 * Feature flag to enable or disable the foreground service starts logging
                 * feature.
                 * Type: int (0 for false, 1 for true)
                 * Default: 1
                 * 
                 ...
                 * </pre>
                 *
                 * See {@link com.android.server.power.batterysaver.BatterySaverPolicy} for the
                 * details.
                 *
                 * @hide
                 */
                ...
                /**
                 * An integer to reduce the FPS by this factor. Only for experiments. Need to
                 * reboot the
                ...
                /**
                 * Broadcast dispatch tuning parameters specific to specific "offline"
                 * broadcasts.
                 *
                 * This is encoded as a key=value list, separated by commas. Ex:
                 * "foo=1,bar=true".
                ...
                /**
                 * Whether or not App Standby feature is enabled by system. This controls
                 * throttling of apps
                 * based on usage patterns and predictions. Platform will turn on this feature
                 * if both this
                ...
                /**
                 * Whether or not adaptive battery feature is enabled by user. Platform will
                 * turn on this
                ...
                /**
                 * Whether or not app auto restriction is enabled. When it is enabled, settings
                 * app will
                 * auto restrict the app if it has bad behavior (e.g. hold wakelock for long
                 * time).
                 *
                ...
                /**
                 * Whether or not to enable the User Absent, Radios Off feature on small battery
                 * devices.
                 * Type: int (0 for false, 1 for true)
                 * Default: 0
                 * 
                ...
                /**
                 * Whether or not to enable the User Absent, Touch Off feature on small battery
                 * devices.
                 * Type: int (0 for false, 1 for true)
                 * Default: 0
                 * 
                ...
                /**
                 * Whether of not to send keycode sleep for ungaze when Home is the foreground
                 * activity on
                 * watch type devices.
                 * Type: int (0 for false, 1 for true)
                 * Default: 0
                ...
                /**
                 * Flag to keep background restricted profiles running after exiting. If
                 * disabled,
                 * the restricted profile can be put into stopped state as soon as the user
                 * leaves it.
                 * Type: int (0 for false, 1 for true)
                 *
                 * Overridden by the system based on device information. If null, the value
                 * specified
                ...
                /**
                 * The default time in ms within which a subsequent connection from an always
                 * allowed system
                ...
                /**
                 * When the user first connects their device to a system a prompt is displayed
                 * to allow
                 * the adb connection with an option to 'Always allow' connections from this
                 * system. If the
                 * user selects this always allow option then the connection time is stored for
                 * the system.
                 * This setting is the time in ms within which a subsequent connection from an
                 * always
                 ...
                 *
                 * The value is a float. Setting to 0.0f will cause animations to end
                 * immediately.
                ...
                /**
                 * A setting that can be read whether the emergency affordance is currently
                 * needed.
                 * The value is a boolean (1 or 0).
                 * 
                 * @hide
                ...
                /**
                 * Whether to enable automatic system server heap dumps. This only works on
                 * userdebug or
                 * eng builds, not on user builds. This is set by the user and overrides the
                 * config value.
                ...
                /**
                 * Package containing ANGLE libraries other than system, which are only
                 * available
                ...
                /**
                 * List of selected OpenGL drivers, corresponding to the PKGs in
                 * GLOBAL_SETTINGS_DRIVER_PKGS
                 * 
                 * @hide
                 */
                @Readable
                 ...
                 * Each list of features is separated by a comma, each feature in each list is
                 * separated by
                 * a colon.
                ...
                /**
                 * Show the "ANGLE In Use" dialog box to the user when ANGLE is the OpenGL
                 * driver.
                 * The value is a boolean (1 or 0).
                 * 
                 * @hide
                ...
                /**
                 * If 1, battery saver ({@link #LOW_POWER_MODE}) will be re-activated after the
                 * device
                ...
                /**
                 * When a device is unplugged from a changer (or is rebooted), do not
                 * re-activate battery
                 * saver even if {@link #LOW_POWER_MODE_STICKY} is 1, if the battery level is
                 * equal to or
                ...
                /**
                 * Whether sticky battery saver should be deactivated once the battery level has
                 * reached the
                 ...
                 * If 0, it will not automatically turn on. For Q and newer, it will only
                 * automatically
                 * turn on if the value is greater than 0 and the
                 * {@link #AUTOMATIC_POWER_SAVE_MODE}
                ...
                /**
                 * Whether battery saver is currently set to trigger based on percentage,
                 * dynamic power
                ...
                /**
                 * The setting that backs the disable threshold for the setPowerSavingsWarning
                 * api in
                 * PowerManager
                 *
                ...
                /**
                 * A long value indicating how much longer the system battery is estimated to
                 * last in
                 * millis. See {@link #BATTERY_ESTIMATES_LAST_UPDATE_TIME} for the last time
                 * this value
                 * was updated.
                 *
                ...
                /**
                 * A boolean indicating whether {@link #TIME_REMAINING_ESTIMATE_MILLIS} is
                 * customized
                 * to the device's usage or using global models. See
                 * {@link #BATTERY_ESTIMATES_LAST_UPDATE_TIME} for the last time this value was
                 * updated.
                 *
                 * @deprecated Use
                 *             {@link PowerManager#isBatteryDischargePredictionPersonalized()}
                 *             instead.
                 *
                 * @hide
                 */
                ...
                /**
                 * A long value indicating how long the system battery takes to deplete from
                 * 100% to 0% on
                 * average based on historical drain rates. See
                 * {@link #BATTERY_ESTIMATES_LAST_UPDATE_TIME}
                 ...
                 * {@link #TIME_REMAINING_ESTIMATE_MILLIS},
                 * {@link #TIME_REMAINING_ESTIMATE_BASED_ON_USAGE},
                 * and {@link #AVERAGE_TIME_TO_DISCHARGE} were last updated.
                 *
                 * @hide
                 * @deprecated No longer needed due to
                 *             {@link PowerManager#getBatteryDischargePrediction}.
                 */
                @Deprecated
                @Readable
                ...
                /**
                 * The max value for {@link #LOW_POWER_MODE_TRIGGER_LEVEL}. If this setting is
                 * not set
                ...
                /**
                 * Surround sounds formats that are enabled when ENCODED_SURROUND_OUTPUT is set
                 * to
                 * ENCODED_SURROUND_OUTPUT_MANUAL. Encoded as comma separated list. Allowed
                 * values
                ...
                /**
                 * Milliseconds after screen-off after which low battery sounds will be
                 * silenced.
                 *
                ...
                /**
                 * Milliseconds to wait before bouncing Wi-Fi after settings is restored. Note
                 * that after
                 * the caller is done with this, they should call {@link ContentResolver#delete}
                 * to
                 ...
                 * <p>
                 * If present, these formats will not be reported to apps, even if the display
                 * supports
                 * them. This list is treated as empty if the
                 * ARE_USER_DISABLED_HDR_FORMATS_ALLOWED setting
                 * is '1'.
                 * </p>
                 * 
                 * @hide
                 ...
                 * <p>
                 * The value is boolean (1 or 0). The value '1' means the user preference for
                 * disabling a
                 * format is ignored, and the disabled formats are still reported to apps (if
                 * supported
                 * by the display). The value '0' means the user-disabled formats are not
                 * reported to
                 * apps, even if the display supports them.
                 * </p>
                 * <p>
                 * The list of formats disabled by the user are contained in the
                 * USER_DISABLED_HDR_FORMATS setting. This list is treated as empty when the
                 * value of
                 * this setting is '1'.
                 * </p>
                 * 
                ...
                /**
                 * Whether or not syncs (bulk set operations) for {@link DeviceConfig} are
                 * disabled
                 * currently. The value is boolean (1 or 0). The value '1' means that {@link
                 * DeviceConfig#setProperties(DeviceConfig.Properties)} will return
                 * {@code false}.
                 *
                 * @hide
                 */
                ...
                /**
                 * @deprecated Use {@link android.provider.Settings.Secure#ZEN_DURATION_PROMPT}
                 *             instead
                 * @hide
                 */
                @Deprecated
                ...
                /**
                 * @deprecated Use {@link android.provider.Settings.Secure#ZEN_DURATION_FOREVER}
                 *             instead
                 * @hide
                 */
                @Deprecated
                ...
                /**
                 * Indicates whether the user wants to be prompted for password to decrypt the
                 * device on
                ...
                /**
                 * Whether the Volte is enabled. If this setting is not set then we use the
                 * Carrier Config
                 * value
                 ...
                 * @hide
                 * @deprecated Use
                 *             {@link android.provider.Telephony.SimInfo#COLUMN_ENHANCED_4G_MODE_ENABLED}
                 *             instead.
                 */
                @Deprecated
                @Readable
                public static final String ENHANCED_4G_MODE_ENABLED = Telephony.SimInfo.COLUMN_ENHANCED_4G_MODE_ENABLED;
                 ...
                 * @hide
                 * @deprecated Use
                 *             {@link android.provider.Telephony.SimInfo#COLUMN_VT_IMS_ENABLED}
                 *             instead.
                 */
                @Deprecated
                @Readable
                 ...
                 * @hide
                 * @deprecated Use
                 *             {@link android.provider.Telephony.SimInfo#COLUMN_WFC_IMS_ENABLED}
                 *             instead.
                 */
                @Deprecated
                @Readable
                 ...
                 * @hide
                 * @deprecated Use
                 *             {@link android.provider.Telephony.SimInfo#COLUMN_WFC_IMS_MODE}
                 *             instead.
                 */
                @Deprecated
                @Readable
                 ...
                 * @hide
                 * @deprecated Use
                 *             {@link android.provider.Telephony.SimInfo#COLUMN_WFC_IMS_ROAMING_MODE}
                 *             instead.
                 */
                @Deprecated
                @Readable
                public static final String WFC_IMS_ROAMING_MODE = Telephony.SimInfo.COLUMN_WFC_IMS_ROAMING_MODE;
                 ...
                 * @hide
                 * @deprecated Use
                 *             {@link android.provider.Telephony.SimInfo#COLUMN_WFC_IMS_ROAMING_ENABLED}
                 *             instead
                 */
                @Deprecated
                @Readable
                public static final String WFC_IMS_ROAMING_ENABLED = Telephony.SimInfo.COLUMN_WFC_IMS_ROAMING_ENABLED;

                /**
                 * Whether user can enable/disable LTE as a preferred network. A carrier might
                 * control
                ...
                /**
                 * Toggle to enable/disable the entire ephemeral feature. By default, ephemeral
                 * is
                ...
                /**
                 * Toggle to enable/disable dexopt for instant applications. The default is for
                 * dexopt
                 * to be disabled.
                 * <p>
                 ...
                 * restriction.
                 * The purpose of the setting is to make the restriction available in early boot
                 * stages
                ...
                /**
                 * Indicates whether this device is currently in retail demo mode. If true, the
                 * device
                ...
                /**
                 * Indicates the maximum time that an app is blocked for the network rules to
                 * get updated.
                 *
                 * Type: long
                 *
                ...
                /**
                 * The build id of when the settings database was first created (or re-created
                 * due it
                 * being missing).
                 *
                 * Type: string
                ...
                /**
                 * Flag to toggle journal mode WAL on or off for the contacts database. WAL is
                 * enabled by
                ...
                /**
                 * Flag to enable the link to location permissions in location setting. Set to 0
                 * to disable.
                 *
                 * @hide
                 */
                ...
                /**
                 * Flag to set the waiting time for removing invisible euicc profiles inside
                 * System >
                 * Settings.
                 * Type: long
                 *
                ...
                /**
                 * If set to 1, SettingsProvider's restoreAnyVersion="true" attribute will be
                 * ignored
                ...
                /**
                 * Flag to toggle whether system services report attribution chains when they
                 * attribute
                 ...
                 * If not set, default adb installations are incremental; set to zero to use
                 * full ones.
                 ...
                 * of packages is {@code ":"} colon delimited, and each entry has the name of
                 * the
                 * package and an optional list of url bar resource ids (the list is delimited
                 * by
                 * brackets&mdash{@code [} and {@code ]}&mdash and is also comma delimited).
                 *
                 * <p>
                 * For example, a list with 3 packages {@code p1}, {@code p2}, and {@code p3},
                 * where
                 * package {@code p1} have one id ({@code url_bar}, {@code p2} has none, and
                 * {@code p3 }
                ...
                /**
                 * Maximum number of visible datasets in the Autofill dataset picker UI, or
                 * {@code 0} to use
                 ...
                 * {@link android.media.soundtrigger.SoundTriggerDetectionService}
                 * operation (in ms).
                 *
                 * @hide
                 */
                ...
                /**
                 * Override internal R.integer.config_longPressOnPowerDurationMs. It determines
                 * the length
                ...
                /**
                 * Keyguard should be on the left hand side of the screen, for wide screen
                 * layouts.
                 *
                 * @hide
                 */
                ...
                /**
                 * Keyguard should be on the right hand side of the screen, for wide screen
                 * layouts.
                 *
                 * @hide
                 */
                ...
                /**
                 * In one handed mode, which side the keyguard should be on. Allowable values
                 * are one of
                ...
                public static void resetToDefaultsAsUser(@NonNull ContentResolver resolver,
                        ...
                        try {
                                ...
                                IContentProvider cp = sProviderHolder.getProvider(resolver);
                                cp.call(resolver.getAttributionSource(),
                                                sProviderHolder.mUri.getAuthority(), CALL_METHOD_RESET_GLOBAL, null,
                                                arg);
                        } catch (RemoteException e) {
                                Log.w(TAG, "Can't reset do defaults for " + CONTENT_URI, e);
                        }
                ...
                /**
                 * Displays toasts when an app posts a notification that does not specify a
                 * valid channel.
                 *
                 * The value 1 - enable, 0 - disable
                 * 
                ...
                /**
                 * Temperature at which the high temperature warning notification should be
                 * shown.
                 * 
                 * @hide
                 */
                ...
                /**
                 * When enabled, notifications the notification assistant service has modified
                 * will show an
                 * indicator. When tapped, this indicator will describe the adjustment made and
                 * solicit
                 * feedback. This flag will also add a "automatic" option to the long press
                 * menu.
                 *
                 * The value 1 - enable, 0 - disable
                 * 
                ...
                /**
                 * Settings key for the ratio of notification dismissals to notification views -
                 * one of the
                 * criteria for showing the notification blocking helper.
                 *
                 * <p>
                 * The value is a float ranging from 0.0 to 1.0 (the closer to 0.0, the more
                 * intrusive
                ...
                /**
                 * Settings key for the longest streak of dismissals - one of the criteria for
                 * showing the
                 ...
                 * <li>
                 * <ul>
                 * {@code legacy_compatibility_wal_enabled} : A {code boolean} flag that
                 * determines
                 * whether or not "compatibility WAL" mode is enabled by default. This is a
                 * legacy flag
                 * and is honoured on Android Q and higher. This flag will be removed in a
                 * future release.
                 * </ul>
                 * <ul>
                 * {@code wal_syncmode} : A {@code String} representing the synchronization mode
                 * to use
                 * when WAL is enabled, either via {@code legacy_compatibility_wal_enabled} or
                 * using the
                 * obsolete {@code compatibility_wal_supported} flag.
                 * </ul>
                 * <ul>
                 * {@code truncate_size} : A {@code int} flag that specifies the truncate size
                 * of the
                 * WAL journal.
                 * </ul>
                 * <ul>
                 * {@code compatibility_wal_supported} : A {code boolean} flag that specifies
                 * whether
                 * the legacy "compatibility WAL" mode is enabled by default. This flag is
                 * obsolete and is
                ...
                /**
                 * Whether the notification should be ongoing (persistent) when a carrier app
                 * install is
                 * required.
                 *
                 * The value is a boolean (1 or 0).
                ...
                /**
                 * The amount of time (ms) to hide the install carrier app notification after
                 * the user has
                 ...
                 * "device_default" will let the system decide whether to enable the freezer or
                 * not
                 * 
                 * @hide
                 */
                ...
                /**
                 * Configuration flags for the automatic generation of smart replies and smart
                 * actions in
                ...
                /**
                 * If nonzero, crash dialogs will show an option to mute all future crash
                 * dialogs for
                 * this app.
                 * 
                 * @hide
                 ...
                 * @hide
                 * @deprecated - Use
                 *             {@link android.provider.Settings.Secure#SHOW_ZEN_UPGRADE_NOTIFICATION}
                 */
                @Deprecated
                public static final String SHOW_ZEN_UPGRADE_NOTIFICATION = "show_zen_upgrade_notification";
                 ...
                 * @hide
                 * @deprecated - Use
                 *             {@link android.provider.Settings.Secure#SHOW_ZEN_SETTINGS_SUGGESTION}
                 */
                @Deprecated
                public static final String SHOW_ZEN_SETTINGS_SUGGESTION = "show_zen_settings_suggestion";
                 ...
                 * 
                 * @deprecated - Use
                 *             {@link android.provider.Settings.Secure#ZEN_SETTINGS_UPDATED}
                 * @hide
                 */
                @Deprecated
                public static final String ZEN_SETTINGS_UPDATED = "zen_settings_updated";
                 ...
                 * @hide
                 * @deprecated - Use
                 *             {@link android.provider.Settings.Secure#ZEN_SETTINGS_SUGGESTION_VIEWED}
                 */
                @Deprecated
                public static final String ZEN_SETTINGS_SUGGESTION_VIEWED = "zen_settings_suggestion_viewed";
                 ...
                 *
                 * Ex:
                 * "kv_backup_agent_timeout_millis=30000,full_backup_agent_timeout_millis=300000"
                 *
                 * @hide
                 */
                @Readable
                 ...
                 *
                 * This is a list of integers separated by commas to represent pairs of
                 * (constellation,
                 * svid). Thus, the number of integers should be even.
                 *
                 * E.g.: "3,0,5,24" denotes (constellation=3, svid=0) and (constellation=5,
                 * svid=24) are
                 * blocklisted. Note that svid=0 denotes all svids in the constellation are
                 * blocklisted.
                 *
                 * @hide
                 */
                ...
                /**
                 * Duration of updates in millisecond for GNSS location request from HAL to
                 * framework.
                 *
                ...
                /**
                 * Whether we've enabled native flags health check on this device. Takes effect
                 * on
                 * reboot. The value "1" enables native flags health check; otherwise it's
                 * disabled.
                 * 
                 * @hide
                 */
                 ...
                 *
                 * Ex:
                 * "mode=HISTORICAL_MODE_ENABLED_ACTIVE,baseIntervalMillis=1000,intervalMultiplier=10"
                 *
                 ...
                 *
                 * Ex:
                 * "enabledForPreRApps=false,unusedThresholdMs=7776000000,checkFrequencyMs=1296000000"
                 *
                 * @hide
                 */
                @Readable
                ...
                /**
                 * A serialized string of params that will be loaded into a text classifier
                 * action model.
                 *
                 * @hide
                 */
                ...
                /**
                 * The amount of time to suppress "power-off" from the power button after the
                 * device has
                 * woken due to a gesture (lifting the phone). Since users have learned to hit
                 * the power
                 * button immediately when lifting their device, it can cause the device to turn
                 * off if a
                 * gesture has just woken the device. This value tells us the milliseconds to
                 * wait after
                 * a gesture before "power-off" via power-button is functional again. A value of
                 * 0 is no
                 ...
                 * 1: extended - All 5G NSA tracking indications are on when the screen is off
                 * as long as
                 ...
                 * 2: always on - All 5G NSA tracking indications are on whether the screen is
                 * on or off.
                 * 
                 * @hide
                 */
                 ...
                 * <li>1 = {@link BlockUntrustedTouchesMode#PERMISSIVE}: Untrusted touches are
                 * flagged
                 * but not blocked
                 * <li>2 = {@link BlockUntrustedTouchesMode#BLOCK}: Untrusted touches are
                 * blocked
                 * </ul>
                 *
                 * @hide
                 ...
                 * {@link LayoutParams
                 * #FLAG_NOT_TOUCHABLE} or not depends on the combined obscuring opacity of the
                 * windows
                 * above the touch-consuming window.
                 *
                 * For a certain UID:
                 * <ul>
                 * <li>If it's the same as the UID of the touch-consuming window, allow it to
                 * propagate
                 * the touch.
                 * <li>Otherwise take all its windows of eligible window types above the
                 * touch-consuming
                 * window, compute their combined obscuring opacity considering that {@code
                 *     opacity(A, B) = 1 - (1 - opacity(A))*(1 - opacity(B))}. If the computed
                 * value is
                 * lesser than or equal to this setting and there are no other windows
                 * preventing the
                ...
                /**
                 * Used to enable / disable the Restricted Networking Mode in which network
                 * access is
                 * restricted to apps holding the CONNECTIVITY_USE_RESTRICTED_NETWORKS
                 * permission.
                 *
                 * Values are:
                 * 0: disabled
        ...
        /**
         * Configuration system settings, containing settings which are applied
         * identically for all
         * defined users. Only Android can read these and only a specific configuration
         * service can
         * write these.
         *
         * @hide
        ...
        public static final class Config extends NameValueTable {
                 ...
                 * @hide
                 */
                @IntDef(prefix = "DISABLE_SYNC_MODE_", value = { SYNC_DISABLED_MODE_NONE, SYNC_DISABLED_MODE_PERSISTENT,
                ...
                /**
                 * Disabling of Config bulk update / syncing is persistent, i.e. it survives a
                 * device
                 * reboot.
                 * 
                 * @hide
                ...
                /**
                 * Disabling of Config bulk update / syncing is not persistent, i.e. it will not
                 * survive a
                 * device reboot.
                 * 
                 * @hide
                ...
                private static final ContentProviderHolder sProviderHolder = new ContentProviderHolder(
                 ...
                 * @return a non null, but possibly empty, map from name to value for any of the
                 *         names that
                 ...
                 * <p>
                 * Also the method takes an argument whether to make the value the default for
                 * this setting.
                 * If the system already specified a default value, then the one passed in here
                 * will
                ...
                /**
                 * Clear all name/value pairs for the provided namespace and save new name/value
                 * pairs in
                 * their place.
                 *
                 * @param resolver  to access the database with.
                 ...
                 * <p>
                 * The method accepts an optional prefix parameter. If provided, only pairs with
                 * a name that
                ...
                static void resetToDefaults(@NonNull ContentResolver resolver, @ResetMode int resetMode,
                        ...
                        try {
                                ...
                                IContentProvider cp = sProviderHolder.getProvider(resolver);
                                cp.call(resolver.getAttributionSource(),
                                                sProviderHolder.mUri.getAuthority(), CALL_METHOD_RESET_CONFIG, null,
                                                arg);
                        } catch (RemoteException e) {
                ...
                static void setSyncDisabled(
                        ...
                        try {
                                ...
                                cp.call(resolver.getAttributionSource(),
                                                ...
                                                CALL_METHOD_SET_SYNC_DISABLED_CONFIG,
                                                null, args);
                        } catch (RemoteException e) {
                ...
                static boolean isSyncDisabled(@NonNull ContentResolver resolver) {
                        try {
                                ...
                                Bundle bundle = cp.call(resolver.getAttributionSource(),
                                                sProviderHolder.mUri.getAuthority(),
                                                CALL_METHOD_IS_SYNC_DISABLED_CONFIG,
                                                null, args);
        ...
        /**
         * <p>
         * A Settings panel is floating UI that contains a fixed subset of settings to
         * address a
         * particular user problem. For example, the
         * {@link #ACTION_INTERNET_CONNECTIVITY Internet Panel} surfaces settings
         * related to
        ...
        public static final class Panel {
                ...
                /**
                 * Activity Action: Show a settings dialog containing settings to enable
                 * internet
                 * connection.
                 * <p>
                 * Input: Nothing.
                 ...
                 */
                @SdkConstant(SdkConstant.SdkConstantType.ACTIVITY_INTENT_ACTION)
                public static final String ACTION_MOBILE_DATA = "android.settings.panel.action.MOBILE_DATA";
                 ...
                 */
                @SdkConstant(SdkConstant.SdkConstantType.ACTIVITY_INTENT_ACTION)
                public static final String ACTION_BLUETOOTH = "android.settings.panel.action.BLUETOOTH";
        }

        /**
         * Activity Action: Show setting page to process the addition of Wi-Fi networks
         * to the user's
         * saved network list. The app should send a new intent with an extra that holds
         * a maximum
         * of five {@link android.net.wifi.WifiNetworkSuggestion} that specify
         * credentials for the
         * networks to be added to the user's database. The Intent should be sent via
         * the
         * {@link android.app.Activity#startActivityForResult(Intent, int)} API.
         * <p>
         * Note: The app sending the Intent to add the credentials doesn't get any
         * ownership over the
         * newly added network(s). For the Wi-Fi stack, these networks will look like
         * the user
         * manually added them from the Settings UI.
         * <p>
         * Input: The app should put parcelable array list of
         * {@link android.net.wifi.WifiNetworkSuggestion} into the
         * {@link #EXTRA_WIFI_NETWORK_LIST}
         * extra.
         * <p>
         * Output: After
         * {@link android.app.Activity#startActivityForResult(Intent, int)}, the
         * callback {@link android.app.Activity#onActivityResult(int, int, Intent)} will
         * have a
         * result code {@link android.app.Activity#RESULT_OK} to indicate user pressed
         * the save
         * button to save the networks or {@link android.app.Activity#RESULT_CANCELED}
         * to indicate
         * that the user rejected the request. Additionally, an integer array list,
         * stored in
         * {@link #EXTRA_WIFI_NETWORK_RESULT_LIST}, will indicate the process result of
         * each network.
         */
        @SdkConstant(SdkConstantType.ACTIVITY_INTENT_ACTION)
        ...
        /**
         * A bundle extra of {@link #ACTION_WIFI_ADD_NETWORKS} intent action that
         * indicates the list
         * of the {@link android.net.wifi.WifiNetworkSuggestion} elements. The maximum
         * count of the
         * {@link android.net.wifi.WifiNetworkSuggestion} elements in the list will be
         * five.
         * <p>
         * For example:
        ...
        /**
         * A bundle extra of the result of {@link #ACTION_WIFI_ADD_NETWORKS} intent
         * action that
         * indicates the action result of the saved
         * {@link android.net.wifi.WifiNetworkSuggestion}.
         * Its value is a list of integers, and all the elements will be 1:1 mapping to
         * the elements
         * in {@link #EXTRA_WIFI_NETWORK_LIST}, if user press cancel to cancel the add
         * networks
         * request, then its value will be null.
         * <p>
         * Note: The integer value will be one of the {@link #ADD_WIFI_RESULT_SUCCESS},
         * {@link #ADD_WIFI_RESULT_ADD_OR_UPDATE_FAILED}, or
         * {@link #ADD_WIFI_RESULT_ALREADY_EXISTS}}.
         */
        ...
        /**
         * A result of {@link #ACTION_WIFI_ADD_NETWORKS} intent action that saving or
         * updating the
        ...
        /**
         * A result of {@link #ACTION_WIFI_ADD_NETWORKS} intent action that saving the
         * corresponding
        ...
        /**
         * A result of {@link #ACTION_WIFI_ADD_NETWORKS} intent action that indicates
         * the Wi-Fi network
         * already exists.
         */
        ...
        /**
         * Activity Action: Show screen for controlling which apps have access to manage
         * external
         * storage.
         * <p>
         * In some cases, a matching Activity may not exist, so ensure you safeguard
         * against this.
         * <p>
         * If you want to control a specific app's access to manage external storage,
         * use
         ...
         * {@link Activity} embedded
         * in Settings app on large screen devices.
         * <p>
         * Input: {@link #EXTRA_SETTINGS_EMBEDDED_DEEP_LINK_INTENT_URI} must be included
         * to
         * specify the intent for the activity which will be embedded in Settings app.
         * It's an intent URI string from
         * {@code intent.toUri(Intent.URI_INTENT_SCHEME)}.
         *
         * Input: {@link #EXTRA_SETTINGS_EMBEDDED_DEEP_LINK_HIGHLIGHT_MENU_KEY} must be
         * included to
         * specify a key that indicates the menu item which will be highlighted on
         * settings home menu.
         * <p>
         * Output: Nothing.
         */
        ...
        /**
         * Activity Extra: Specify the intent for the {@link Activity} which will be
         * embedded in
        ...
        /**
         * Activity Extra: Specify a key that indicates the menu item which should be
         * highlighted on
         * settings home menu.
         * <p>
         * This must be passed as an extra field to
        ...
        /**
         * Performs a strict and comprehensive check of whether a calling package is
         * allowed to
        ...
        /**
         * @deprecated Use
         *             {@link #checkAndNoteWriteSettingsOperation(Context, int, String, String,
         *             boolean)} instead.
         *
         * @hide
         */
         ...
         * write/modify system settings, as the condition differs for pre-M, M+, and
         * privileged/preinstalled apps. If the provided uid does not match the
         * callingPackage, a negative result will be returned. The caller is expected to
         * have
         * the WRITE_SETTINGS permission declared.
         *
         * Note: if the check is successful, the operation of this app will be updated
         * to the
         * current time.
         * 
         * @hide
        ...
        /**
         * @deprecated Use
         *             {@link #isCallingPackageAllowedToPerformAppOpsProtectedOperation(Context,
        ...
        /**
         * Helper method to perform a general and comprehensive check of whether an
         * operation that is
         * protected by appops can be performed by a caller or not. e.g.
         * OP_SYSTEM_ALERT_WINDOW and
         * OP_WRITE_SETTINGS
         * 
         * @hide
         */
